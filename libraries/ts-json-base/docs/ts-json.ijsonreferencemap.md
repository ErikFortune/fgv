...
Interface for a simple map that returns named [JsonValue](./ts-json.jsonvalue.md) values with templating, conditional logic, and external reference lookups applied using an optionally supplied context.
