...
[Home](./index.md) &gt; [@fgv/ts-json-base](./ts-json-base.md) &gt; [FileTree](./ts-json-base.filetree.md) &gt; [IFileTreeFileItem](./ts-json-base.filetree.ifiletreefileitem.md) &gt; [getIsMutable](./ts-json-base.filetree.ifiletreefileitem.getismutable.md)

## FileTree.IFileTreeFileItem.getIsMutable() method
