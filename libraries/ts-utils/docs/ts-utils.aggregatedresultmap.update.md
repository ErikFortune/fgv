...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [AggregatedResultMap](./ts-utils.aggregatedresultmap.md) &gt; [update](./ts-utils.aggregatedresultmap.update.md)

## AggregatedResultMap.update() method
