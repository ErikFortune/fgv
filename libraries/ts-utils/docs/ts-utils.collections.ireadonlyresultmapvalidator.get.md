...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [IReadOnlyResultMapValidator](./ts-utils.collections.ireadonlyresultmapvalidator.md) &gt; [get](./ts-utils.collections.ireadonlyresultmapvalidator.get.md)

## Collections.IReadOnlyResultMapValidator.get() method
