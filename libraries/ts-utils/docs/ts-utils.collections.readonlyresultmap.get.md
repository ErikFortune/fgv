...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ReadOnlyResultMap](./ts-utils.collections.readonlyresultmap.md) &gt; [get](./ts-utils.collections.readonlyresultmap.get.md)

## Collections.ReadOnlyResultMap.get() method
