...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMapConverter](./ts-utils.collections.resultmapconverter.md) &gt; [get](./ts-utils.collections.resultmapconverter.get.md)

## Collections.ResultMapConverter.get() method
