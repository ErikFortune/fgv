...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [ValidatingResultMap](./ts-utils.validatingresultmap.md) &gt; [update](./ts-utils.validatingresultmap.update.md)

## ValidatingResultMap.update() method
