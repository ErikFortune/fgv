...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [AggregatedResultMapBase](./ts-utils.collections.aggregatedresultmapbase.md) &gt; [delete](./ts-utils.collections.aggregatedresultmapbase.delete.md)

## Collections.AggregatedResultMapBase.delete() method
