...
[@fgv/ts-utils](../../../../README.md) / [Conversion](../README.md) / ObjectConverter
...
| ------ | ------ | ------ | ------ |
| <a id="fields"></a> `fields` | `readonly` | [`FieldConverters`](../type-aliases/FieldConverters.md)\<`T`, `TC`\> | Fields converted by this ObjectConverter. |
| <a id="options"></a> `options` | `readonly` | [`ObjectConverterOptions`](../interfaces/ObjectConverterOptions.md)\<`T`\> | Options used to initialize this ObjectConverter. |
