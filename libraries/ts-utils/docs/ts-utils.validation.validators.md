...
|  [oneOf(validators, params)](./ts-utils.validation.validators.oneof.md) | Helper function to create a [Validator](./ts-utils.validation.validator.md) which validates one of several possible validated values. |
