...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [IResultMap](./ts-utils.collections.iresultmap.md) &gt; [get](./ts-utils.collections.iresultmap.get.md)

## Collections.IResultMap.get() method
