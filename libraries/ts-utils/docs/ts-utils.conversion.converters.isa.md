...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [Converters](./ts-utils.conversion.converters.md) &gt; [isA](./ts-utils.conversion.converters.isa.md)

## Conversion.Converters.isA() function
