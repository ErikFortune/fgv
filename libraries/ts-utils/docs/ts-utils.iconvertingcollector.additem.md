...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [IConvertingCollector](./ts-utils.iconvertingcollector.md) &gt; [addItem](./ts-utils.iconvertingcollector.additem.md)

## IConvertingCollector.addItem() method
