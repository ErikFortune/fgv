...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [Converter](./ts-utils.conversion.converter.md) &gt; [withBrand](./ts-utils.conversion.converter.withbrand.md)

## Conversion.Converter.withBrand() method
