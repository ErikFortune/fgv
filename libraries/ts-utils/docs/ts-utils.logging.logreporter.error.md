...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Logging](./ts-utils.logging.md) &gt; [LogReporter](./ts-utils.logging.logreporter.md) &gt; [error](./ts-utils.logging.logreporter.error.md)

## Logging.LogReporter.error() method
