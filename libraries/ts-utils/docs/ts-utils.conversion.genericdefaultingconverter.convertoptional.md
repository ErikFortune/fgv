...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [GenericDefaultingConverter](./ts-utils.conversion.genericdefaultingconverter.md) &gt; [convertOptional](./ts-utils.conversion.genericdefaultingconverter.convertoptional.md)

## Conversion.GenericDefaultingConverter.convertOptional() method
...
|  context | TC \| undefined | _(Optional)_ An optional conversion context of type <code>&lt;TC&gt;</code> to be used in the conversion. |
...
[Result](./ts-utils.result.md)<!-- -->&lt;T \| TD \| undefined&gt;
