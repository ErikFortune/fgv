...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Validation](./ts-utils.validation.md) &gt; [Base](./ts-utils.validation.base.md) &gt; [GenericValidator](./ts-utils.validation.base.genericvalidator.md) &gt; [convert](./ts-utils.validation.base.genericvalidator.convert.md)

## Validation.Base.GenericValidator.convert() method
