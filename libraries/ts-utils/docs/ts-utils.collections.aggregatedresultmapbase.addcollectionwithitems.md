...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [AggregatedResultMapBase](./ts-utils.collections.aggregatedresultmapbase.md) &gt; [addCollectionWithItems](./ts-utils.collections.aggregatedresultmapbase.addcollectionwithitems.md)

## Collections.AggregatedResultMapBase.addCollectionWithItems() method
