...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [IConvertingCollector](./ts-utils.iconvertingcollector.md) &gt; [getOrAddItem](./ts-utils.iconvertingcollector.getoradditem.md)

## IConvertingCollector.getOrAddItem() method
