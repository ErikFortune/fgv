[Home](../README.md) > [Success](./Success.md) > shouldNotFail

## Success.shouldNotFail() method
...
<tbody>
<tr><td>__label</td><td>string</td><td>Optional human-meaningful identifier (e.g. the constant
name) prefixed to the error message.</td></tr>
<tr><td>__frameDepth</td><td>number</td><td>Optional 1-indexed depth into the caller stack.
