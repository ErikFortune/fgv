[Home](../README.md) > [Failure](./Failure.md) > onSuccess
...
```typescript
onSuccess(__: SuccessContinuation<T, TN>): Result<TN>;
```
...
<tbody>
<tr><td>__</td><td>SuccessContinuation&lt;T, TN&gt;</td><td>The SuccessContinuation | success continuation to
