[Home](../README.md) > RetainingLogger

# Class: RetainingLogger
...
**Extends:** [`LoggerBase`](LoggerBase.md)
...
`constructor(logLevel, maxRecords, now)`
...
[records](./RetainingLogger.records.md)
...
[lastSeq](./RetainingLogger.lastSeq.md)
...
[getRecords(options)](./RetainingLogger.getRecords.md)
...
[clear()](./RetainingLogger.clear.md)
