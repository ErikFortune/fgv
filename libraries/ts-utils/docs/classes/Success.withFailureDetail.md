[Home](../README.md) > [Success](./Success.md) > withFailureDetail
...
```typescript
withFailureDetail(__detail: TD): DetailedResult<T, TD>;
```
...
<tbody>
<tr><td>__detail</td><td>TD</td><td>The detail to be added if this operation failed.</td></tr>
</tbody></table>
