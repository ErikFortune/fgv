...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMapConverter](./ts-utils.collections.resultmapconverter.md) &gt; [add](./ts-utils.collections.resultmapconverter.add.md)

## Collections.ResultMapConverter.add() method
