...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [Converter](./ts-utils.conversion.converter.md) &gt; [withConstraint](./ts-utils.conversion.converter.withconstraint.md)

## Conversion.Converter.withConstraint() method
