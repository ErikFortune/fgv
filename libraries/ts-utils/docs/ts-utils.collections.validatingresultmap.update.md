...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [update](./ts-utils.collections.validatingresultmap.update.md)

## Collections.ValidatingResultMap.update() method
