...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [set](./ts-utils.collections.validatingresultmap.set.md)

## Collections.ValidatingResultMap.set() method
