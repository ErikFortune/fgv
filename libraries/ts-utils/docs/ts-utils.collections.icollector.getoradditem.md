...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ICollector](./ts-utils.collections.icollector.md) &gt; [getOrAddItem](./ts-utils.collections.icollector.getoradditem.md)

## Collections.ICollector.getOrAddItem() method
