[Home](../../README.md) > [Conversion](../README.md) > BaseConverter

# Class: BaseConverter

Base templated wrapper to simplify creation of new Converters.

**Implements:** [`Converter<T, TC>`](../../interfaces/Converter.md)
...
Constructs a new Converter which uses the supplied function to perform the conversion.
