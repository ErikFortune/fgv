...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Experimental](./ts-utils.experimental.md) &gt; [ExtendedArray](./ts-utils.experimental.extendedarray.md) &gt; [single](./ts-utils.experimental.extendedarray.single.md)
