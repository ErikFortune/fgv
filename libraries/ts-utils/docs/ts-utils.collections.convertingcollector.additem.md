...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ConvertingCollector](./ts-utils.collections.convertingcollector.md) &gt; [addItem](./ts-utils.collections.convertingcollector.additem.md)

## Collections.ConvertingCollector.addItem() method
