...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [Converter](./ts-utils.conversion.converter.md) &gt; [convertOptional](./ts-utils.conversion.converter.convertoptional.md)

## Conversion.Converter.convertOptional() method
