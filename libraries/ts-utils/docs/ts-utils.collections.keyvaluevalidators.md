...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [KeyValueValidators](./ts-utils.collections.keyvaluevalidators.md)

## Collections.KeyValueValidators class
...
[(constructor)(key, value, entry)](./ts-utils.collections.keyvaluevalidators._constructor_.md)
...
[entry?](./ts-utils.collections.keyvaluevalidators.entry.md)
...
[key](./ts-utils.collections.keyvaluevalidators.key.md)
...
[value](./ts-utils.collections.keyvaluevalidators.value.md)
...
[validateEntries(entries)](./ts-utils.collections.keyvaluevalidators.validateentries.md)
...
[validateEntry(entry)](./ts-utils.collections.keyvaluevalidators.validateentry.md)
...
[validateKey(key)](./ts-utils.collections.keyvaluevalidators.validatekey.md)
...
[validateValue(key)](./ts-utils.collections.keyvaluevalidators.validatevalue.md)
