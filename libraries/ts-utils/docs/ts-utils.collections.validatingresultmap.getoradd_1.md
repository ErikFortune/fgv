...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [getOrAdd](./ts-utils.collections.validatingresultmap.getoradd_1.md)

## Collections.ValidatingResultMap.getOrAdd() method
