[Home](../../README.md) > [Collections](../README.md) > [CollectorValidator](./CollectorValidator.md) > add

## CollectorValidator.add() method
...
<tbody>
<tr><td>item</td><td>unknown</td><td>The item to add.</td></tr>
</tbody></table>
