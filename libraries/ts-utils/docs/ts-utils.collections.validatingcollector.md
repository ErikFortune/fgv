...
Constructs a new [ValidatingCollector](./ts-utils.collections.validatingcollector.md) from the supplied [parameters](./ts-utils.collections.ivalidatingcollectorconstructorparams.md)<!-- -->.
