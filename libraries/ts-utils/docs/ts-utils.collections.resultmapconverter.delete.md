...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMapConverter](./ts-utils.collections.resultmapconverter.md) &gt; [delete](./ts-utils.collections.resultmapconverter.delete.md)

## Collections.ResultMapConverter.delete() method
