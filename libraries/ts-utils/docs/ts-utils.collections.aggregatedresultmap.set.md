...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [AggregatedResultMap](./ts-utils.collections.aggregatedresultmap.md) &gt; [set](./ts-utils.collections.aggregatedresultmap.set.md)

## Collections.AggregatedResultMap.set() method
