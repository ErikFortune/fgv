...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Logging](./ts-utils.logging.md) &gt; [ILogger](./ts-utils.logging.ilogger.md) &gt; [info](./ts-utils.logging.ilogger.info.md)

## Logging.ILogger.info() method
