...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [createValidating](./ts-utils.collections.validatingresultmap.createvalidating.md)

## Collections.ValidatingResultMap.createValidating() method
