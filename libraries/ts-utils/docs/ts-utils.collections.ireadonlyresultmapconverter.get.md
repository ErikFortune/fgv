...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [IReadOnlyResultMapConverter](./ts-utils.collections.ireadonlyresultmapconverter.md) &gt; [get](./ts-utils.collections.ireadonlyresultmapconverter.get.md)

## Collections.IReadOnlyResultMapConverter.get() method
