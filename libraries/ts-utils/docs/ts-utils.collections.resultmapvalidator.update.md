...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMapValidator](./ts-utils.collections.resultmapvalidator.md) &gt; [update](./ts-utils.collections.resultmapvalidator.update.md)

## Collections.ResultMapValidator.update() method
