...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMap](./ts-utils.collections.resultmap.md) &gt; [getOrAdd](./ts-utils.collections.resultmap.getoradd_1.md)

## Collections.ResultMap.getOrAdd() method
