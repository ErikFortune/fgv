...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [ConvertingResultMap](./ts-utils.convertingresultmap.md) &gt; [set](./ts-utils.convertingresultmap.set.md)

## ConvertingResultMap.set() method
