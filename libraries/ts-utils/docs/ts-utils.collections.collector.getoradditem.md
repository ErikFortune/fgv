...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [Collector](./ts-utils.collections.collector.md) &gt; [getOrAddItem](./ts-utils.collections.collector.getoradditem.md)

## Collections.Collector.getOrAddItem() method
