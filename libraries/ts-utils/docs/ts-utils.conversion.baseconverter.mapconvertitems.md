...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [BaseConverter](./ts-utils.conversion.baseconverter.md) &gt; [mapConvertItems](./ts-utils.conversion.baseconverter.mapconvertitems.md)

## Conversion.BaseConverter.mapConvertItems() method
