...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [KeyValueValidators](./ts-utils.collections.keyvaluevalidators.md) &gt; [(constructor)](./ts-utils.collections.keyvaluevalidators._constructor_.md)

## Collections.KeyValueValidators.(constructor)
