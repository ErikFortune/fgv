...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [get](./ts-utils.collections.validatingresultmap.get.md)

## Collections.ValidatingResultMap.get() method
