...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Conversion](./ts-utils.conversion.md) &gt; [GenericDefaultingConverter](./ts-utils.conversion.genericdefaultingconverter.md) &gt; [mapConvertItems](./ts-utils.conversion.genericdefaultingconverter.mapconvertitems.md)

## Conversion.GenericDefaultingConverter.mapConvertItems() method
