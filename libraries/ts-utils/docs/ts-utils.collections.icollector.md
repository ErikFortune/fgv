...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ICollector](./ts-utils.collections.icollector.md)

## Collections.ICollector interface
...
[getOrAdd(key, callback)](./ts-utils.collections.icollector.getoradd_1.md)
...
[toReadOnly()](./ts-utils.collections.icollector.toreadonly.md)
