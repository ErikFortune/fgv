...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ValidatingResultMap](./ts-utils.collections.validatingresultmap.md) &gt; [add](./ts-utils.collections.validatingresultmap.add.md)

## Collections.ValidatingResultMap.add() method
