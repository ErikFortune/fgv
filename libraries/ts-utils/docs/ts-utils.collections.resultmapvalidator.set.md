...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Collections](./ts-utils.collections.md) &gt; [ResultMapValidator](./ts-utils.collections.resultmapvalidator.md) &gt; [set](./ts-utils.collections.resultmapvalidator.set.md)

## Collections.ResultMapValidator.set() method
