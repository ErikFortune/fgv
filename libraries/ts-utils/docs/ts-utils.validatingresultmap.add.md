...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [ValidatingResultMap](./ts-utils.validatingresultmap.md) &gt; [add](./ts-utils.validatingresultmap.add.md)

## ValidatingResultMap.add() method
