...
[@fgv/ts-json](../../../../README.md) / [Diff](../README.md) / jsonDiff

# Function: jsonDiff()

> **jsonDiff**(`obj1`, `obj2`, `options`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`IDiffResult`](../interfaces/IDiffResult.md)\>
...
| ------ | ------ | ------ |
| `obj1` | [`JsonValue`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-json-base/docs) | The first JSON value to compare (often the "before" state) |
| `obj2` | [`JsonValue`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-json-base/docs) | The second JSON value to compare (often the "after" state) |
| `options` | [`IJsonDiffOptions`](../interfaces/IJsonDiffOptions.md) | Optional configuration for customizing diff behavior |

## Returns

[`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`IDiffResult`](../interfaces/IDiffResult.md)\>
