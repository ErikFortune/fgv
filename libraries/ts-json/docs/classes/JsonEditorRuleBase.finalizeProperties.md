[Home](../README.md) > [JsonEditorRuleBase](./JsonEditorRuleBase.md) > finalizeProperties
...
<tbody>
<tr><td>__deferred</td><td>JsonObject[]</td><td>Any JSON objects that were deferred during the first edit pass.</td></tr>
