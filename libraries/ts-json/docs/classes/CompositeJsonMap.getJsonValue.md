[Home](../README.md) > [CompositeJsonMap](./CompositeJsonMap.md) > getJsonValue
...
<tr><td>context</td><td>IJsonContext</td><td>An optional IJsonContext | JSON Context used to format the value.</td></tr>
</tbody></table>
