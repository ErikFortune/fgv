...
[@fgv/ts-json](../README.md) / TemplatedJsonConverter
...
> **new TemplatedJsonConverter**(`options?`): `TemplatedJsonConverter`

Constructs a new TemplatedJsonConverter with
...
| ------ | ------ | ------ |
| `options?` | `Partial`\<[`TemplatedJsonConverterOptions`](../type-aliases/TemplatedJsonConverterOptions.md)\> | Optional partial [options](../type-aliases/TemplatedJsonConverterOptions.md) to configure the converter. |
...
| <a id="templateoptions"></a> `templateOptions` | `readonly` | `Partial`\<[`IJsonConverterOptions`](../interfaces/IJsonConverterOptions.md)\> | Default [JSON converter options](../interfaces/IJsonConverterOptions.md) to enable templated conversion. |
...
> `static` **create**(`options?`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`JsonConverter`](JsonConverter.md)\>
...
[`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`JsonConverter`](JsonConverter.md)\>
