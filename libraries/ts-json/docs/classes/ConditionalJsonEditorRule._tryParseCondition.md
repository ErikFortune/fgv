[Home](../README.md) > [ConditionalJsonEditorRule](./ConditionalJsonEditorRule.md) > _tryParseCondition
...
<tbody>
<tr><td>key</td><td>string</td><td>The property key to be considered.</td></tr>
