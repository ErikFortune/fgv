...
[@fgv/ts-json](../README.md) / RichJsonConverter
...
> **new RichJsonConverter**(`options?`): `RichJsonConverter`

Constructs a new RichJsonConverter with supplied or
default options.
...
| ------ | ------ | ------ |
| `options?` | `Partial`\<[`RichJsonConverterOptions`](../type-aliases/RichJsonConverterOptions.md)\> | Optional partial [configuration or context](../type-aliases/RichJsonConverterOptions.md) for the converter. |
...
| <a id="richoptions"></a> `richOptions` | `readonly` | `Partial`\<[`IJsonConverterOptions`](../interfaces/IJsonConverterOptions.md)\> | Default [JSON converter options](../interfaces/IJsonConverterOptions.md) to enable rich conversion. |
