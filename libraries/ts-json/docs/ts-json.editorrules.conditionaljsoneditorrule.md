...
|  --- | --- | --- |
|  [(constructor)(options)](./ts-json.editorrules.conditionaljsoneditorrule._constructor_.md) |  | Creates a new [ConditionalJsonEditorRule](./ts-json.editorrules.conditionaljsoneditorrule.md)<!-- -->. |

## Methods

|  Method | Modifiers | Description |
|  --- | --- | --- |
|  [create(options)](./ts-json.editorrules.conditionaljsoneditorrule.create.md) | <code>static</code> | Creates a new [ConditionalJsonEditorRule](./ts-json.editorrules.conditionaljsoneditorrule.md)<!-- -->. |
