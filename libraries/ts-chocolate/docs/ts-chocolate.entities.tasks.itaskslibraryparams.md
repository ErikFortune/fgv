...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [Tasks](./ts-chocolate.entities.tasks.md) &gt; [ITasksLibraryParams](./ts-chocolate.entities.tasks.itaskslibraryparams.md)

## Entities.Tasks.ITasksLibraryParams type
