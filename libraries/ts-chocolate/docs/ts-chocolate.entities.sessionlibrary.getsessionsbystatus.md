...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [SessionLibrary](./ts-chocolate.entities.sessionlibrary.md) &gt; [getSessionsByStatus](./ts-chocolate.entities.sessionlibrary.getsessionsbystatus.md)

## Entities.SessionLibrary.getSessionsByStatus() method
