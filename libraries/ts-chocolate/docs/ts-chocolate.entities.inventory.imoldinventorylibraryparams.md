...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [Inventory](./ts-chocolate.entities.inventory.md) &gt; [IMoldInventoryLibraryParams](./ts-chocolate.entities.inventory.imoldinventorylibraryparams.md)

## Entities.Inventory.IMoldInventoryLibraryParams type
