...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [IRuntimeFillingRecipe](./ts-chocolate.runtime.iruntimefillingrecipe.md) &gt; [usesIngredient](./ts-chocolate.runtime.iruntimefillingrecipe.usesingredient.md)

## Runtime.IRuntimeFillingRecipe.usesIngredient() method
