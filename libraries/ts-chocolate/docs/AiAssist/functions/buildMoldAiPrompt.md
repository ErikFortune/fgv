[Home](../../README.md) > [AiAssist](../README.md) > buildMoldAiPrompt

# Function: buildMoldAiPrompt
...
```typescript
function buildMoldAiPrompt(moldDescription: string, additionalInstructions: string): AiPrompt
```
