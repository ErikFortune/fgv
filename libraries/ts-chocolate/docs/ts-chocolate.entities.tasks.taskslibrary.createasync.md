...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [Tasks](./ts-chocolate.entities.tasks.md) &gt; [TasksLibrary](./ts-chocolate.entities.tasks.taskslibrary.md) &gt; [createAsync](./ts-chocolate.entities.tasks.taskslibrary.createasync.md)

## Entities.Tasks.TasksLibrary.createAsync() method
