...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [LibraryRuntime](./ts-chocolate.libraryruntime.md) &gt; [RuntimeIngredient](./ts-chocolate.libraryruntime.runtimeingredient.md) &gt; [create](./ts-chocolate.libraryruntime.runtimeingredient.create.md)

## LibraryRuntime.RuntimeIngredient.create() method
