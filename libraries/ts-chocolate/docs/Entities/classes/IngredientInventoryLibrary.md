[Home](../../README.md) > [Entities](../README.md) > IngredientInventoryLibrary
...
**Extends:** [`SubLibraryBase<IngredientInventoryEntryId, IngredientInventoryEntryBaseId, IIngredientInventoryEntryEntity>`](../../classes/SubLibraryBase.md)
...
[create(params)](./IngredientInventoryLibrary.create.md)
...
Creates a new Entities.Inventory.IngredientInventoryLibrary | IngredientInventoryLibrary instance.

</td></tr>
<tr><td>

[createAsync(params)](./IngredientInventoryLibrary.createAsync.md)
...
[getForIngredient(ingredientId)](./IngredientInventoryLibrary.getForIngredient.md)
...
[hasForIngredient(ingredientId)](./IngredientInventoryLibrary.hasForIngredient.md)
...
[getAllEntries()](./IngredientInventoryLibrary.getAllEntries.md)
...
[addEntry(collectionId, entryId, entry)](./IngredientInventoryLibrary.addEntry.md)
...
[upsertEntry(collectionId, entryId, entry)](./IngredientInventoryLibrary.upsertEntry.md)
...
[removeEntry(entryId)](./IngredientInventoryLibrary.removeEntry.md)
...
[removeForIngredient(ingredientId)](./IngredientInventoryLibrary.removeForIngredient.md)
...
[createCollection(collectionId, metadata)](./IngredientInventoryLibrary.createCollection.md)
