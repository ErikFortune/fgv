[Home](../../README.md) > [Entities](../README.md) > MoldInventoryLibrary
...
**Extends:** [`SubLibraryBase<MoldInventoryEntryId, MoldInventoryEntryBaseId, IMoldInventoryEntryEntity>`](../../classes/SubLibraryBase.md)
...
[create(params)](./MoldInventoryLibrary.create.md)
...
Creates a new Entities.Inventory.MoldInventoryLibrary | MoldInventoryLibrary instance.

</td></tr>
<tr><td>

[createAsync(params)](./MoldInventoryLibrary.createAsync.md)
...
[getForMold(moldId)](./MoldInventoryLibrary.getForMold.md)
...
[hasForMold(moldId)](./MoldInventoryLibrary.hasForMold.md)
...
[getAllEntries()](./MoldInventoryLibrary.getAllEntries.md)
...
[addEntry(collectionId, entryId, entry)](./MoldInventoryLibrary.addEntry.md)
...
[upsertEntry(collectionId, entryId, entry)](./MoldInventoryLibrary.upsertEntry.md)
...
[removeEntry(entryId)](./MoldInventoryLibrary.removeEntry.md)
...
[removeForMold(moldId)](./MoldInventoryLibrary.removeForMold.md)
...
[createCollection(collectionId, metadata)](./MoldInventoryLibrary.createCollection.md)
