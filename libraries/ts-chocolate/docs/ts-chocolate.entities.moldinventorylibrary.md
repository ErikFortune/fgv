...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [MoldInventoryLibrary](./ts-chocolate.entities.moldinventorylibrary.md)
...
[addEntry(collectionId, entryId, entry)](./ts-chocolate.entities.moldinventorylibrary.addentry.md)
...
[create(params)](./ts-chocolate.entities.moldinventorylibrary.create.md)
...
[createAsync(params)](./ts-chocolate.entities.moldinventorylibrary.createasync.md)
...
[createCollection(collectionId, metadata)](./ts-chocolate.entities.moldinventorylibrary.createcollection.md)
...
[getAllEntries()](./ts-chocolate.entities.moldinventorylibrary.getallentries.md)
...
[getForMold(moldId)](./ts-chocolate.entities.moldinventorylibrary.getformold.md)
...
[hasForMold(moldId)](./ts-chocolate.entities.moldinventorylibrary.hasformold.md)
...
[removeEntry(entryId)](./ts-chocolate.entities.moldinventorylibrary.removeentry.md)
...
[removeForMold(moldId)](./ts-chocolate.entities.moldinventorylibrary.removeformold.md)
...
[upsertEntry(collectionId, entryId, entry)](./ts-chocolate.entities.moldinventorylibrary.upsertentry.md)
