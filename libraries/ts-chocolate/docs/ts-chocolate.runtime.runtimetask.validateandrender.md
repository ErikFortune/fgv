...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [RuntimeTask](./ts-chocolate.runtime.runtimetask.md) &gt; [validateAndRender](./ts-chocolate.runtime.runtimetask.validateandrender.md)

## Runtime.RuntimeTask.validateAndRender() method
