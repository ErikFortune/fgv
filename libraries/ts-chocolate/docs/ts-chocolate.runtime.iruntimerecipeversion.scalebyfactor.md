...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [IRuntimeRecipeVersion](./ts-chocolate.runtime.iruntimerecipeversion.md) &gt; [scaleByFactor](./ts-chocolate.runtime.iruntimerecipeversion.scalebyfactor.md)

## Runtime.IRuntimeRecipeVersion.scaleByFactor() method
