...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Calculations](./ts-chocolate.calculations.md) &gt; [scaleVersion](./ts-chocolate.calculations.scaleversion.md)

## Calculations.scaleVersion() function
...
_(Optional)_ Optional [scaling options](./ts-chocolate.calculations.iversionscaleoptions.md)
