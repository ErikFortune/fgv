...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [MoldInventoryLibrary](./ts-chocolate.entities.moldinventorylibrary.md) &gt; [upsertEntry](./ts-chocolate.entities.moldinventorylibrary.upsertentry.md)

## Entities.MoldInventoryLibrary.upsertEntry() method
