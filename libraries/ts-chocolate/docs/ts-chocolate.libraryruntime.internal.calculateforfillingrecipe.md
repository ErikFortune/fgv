...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [LibraryRuntime](./ts-chocolate.libraryruntime.md) &gt; [Internal](./ts-chocolate.libraryruntime.internal.md) &gt; [calculateForFillingRecipe](./ts-chocolate.libraryruntime.internal.calculateforfillingrecipe.md)

## LibraryRuntime.Internal.calculateForFillingRecipe() function
