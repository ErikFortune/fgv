...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [SessionLibrary](./ts-chocolate.entities.sessionlibrary.md) &gt; [createAsync](./ts-chocolate.entities.sessionlibrary.createasync.md)

## Entities.SessionLibrary.createAsync() method
