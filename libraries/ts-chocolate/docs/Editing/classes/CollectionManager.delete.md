[Home](../../README.md) > [Editing](../README.md) > [CollectionManager](./CollectionManager.md) > delete

## CollectionManager.delete() method
...
```typescript
delete(collectionId: CollectionId): Result<AggregatedResultMapEntry<CollectionId, TBaseId, TItem, ICollectionSourceMetadata>>;
```
