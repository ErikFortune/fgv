...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [IRuntimeTask](./ts-chocolate.runtime.iruntimetask.md) &gt; [validateParams](./ts-chocolate.runtime.iruntimetask.validateparams.md)

## Runtime.IRuntimeTask.validateParams() method
