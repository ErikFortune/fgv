...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [LibraryRuntime](./ts-chocolate.libraryruntime.md) &gt; [IFillingRecipe](./ts-chocolate.libraryruntime.ifillingrecipe.md) &gt; [usesIngredient](./ts-chocolate.libraryruntime.ifillingrecipe.usesingredient.md)

## LibraryRuntime.IFillingRecipe.usesIngredient() method
