...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [IngredientInventoryLibrary](./ts-chocolate.entities.ingredientinventorylibrary.md)
...
[addEntry(collectionId, entryId, entry)](./ts-chocolate.entities.ingredientinventorylibrary.addentry.md)
...
[create(params)](./ts-chocolate.entities.ingredientinventorylibrary.create.md)
...
[createAsync(params)](./ts-chocolate.entities.ingredientinventorylibrary.createasync.md)
...
[createCollection(collectionId, metadata)](./ts-chocolate.entities.ingredientinventorylibrary.createcollection.md)
...
[getAllEntries()](./ts-chocolate.entities.ingredientinventorylibrary.getallentries.md)
...
[getForIngredient(ingredientId)](./ts-chocolate.entities.ingredientinventorylibrary.getforingredient.md)
...
[hasForIngredient(ingredientId)](./ts-chocolate.entities.ingredientinventorylibrary.hasforingredient.md)
...
[removeEntry(entryId)](./ts-chocolate.entities.ingredientinventorylibrary.removeentry.md)
...
[removeForIngredient(ingredientId)](./ts-chocolate.entities.ingredientinventorylibrary.removeforingredient.md)
...
[upsertEntry(collectionId, entryId, entry)](./ts-chocolate.entities.ingredientinventorylibrary.upsertentry.md)
