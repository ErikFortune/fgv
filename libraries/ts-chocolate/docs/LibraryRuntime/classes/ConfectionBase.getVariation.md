[Home](../../README.md) > [LibraryRuntime](../README.md) > [ConfectionBase](./ConfectionBase.md) > getVariation

## ConfectionBase.getVariation() method
...
Success with runtime variation, or Failure if not found or creation fails
