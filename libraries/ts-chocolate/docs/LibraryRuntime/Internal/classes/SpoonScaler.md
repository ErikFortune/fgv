[Home](../../../README.md) > [LibraryRuntime](../../README.md) > [Internal](../README.md) > SpoonScaler
...
`constructor(sourceUnit, options)`
...
[supportsScaling](./SpoonScaler.supportsScaling.md)
...
[scale(amount, factor)](./SpoonScaler.scale.md)
