...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [IRuntimeRecipe](./ts-chocolate.runtime.iruntimerecipe.md) &gt; [getIngredientIds](./ts-chocolate.runtime.iruntimerecipe.getingredientids.md)

## Runtime.IRuntimeRecipe.getIngredientIds() method
