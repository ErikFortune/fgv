...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Fillings](./ts-chocolate.fillings.md) &gt; [scaleFillingRecipe](./ts-chocolate.fillings.scalefillingrecipe.md)

## Fillings.scaleFillingRecipe() function
...
_(Optional)_ Optional [scaling options](./ts-chocolate.fillings.ifillingrecipescaleoptions.md)
