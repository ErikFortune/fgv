...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [LibraryRuntime](./ts-chocolate.libraryruntime.md) &gt; [ITask](./ts-chocolate.libraryruntime.itask.md) &gt; [validateParams](./ts-chocolate.libraryruntime.itask.validateparams.md)

## LibraryRuntime.ITask.validateParams() method
