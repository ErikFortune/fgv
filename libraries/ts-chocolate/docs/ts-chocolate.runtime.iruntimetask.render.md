...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [IRuntimeTask](./ts-chocolate.runtime.iruntimetask.md) &gt; [render](./ts-chocolate.runtime.iruntimetask.render.md)

## Runtime.IRuntimeTask.render() method
