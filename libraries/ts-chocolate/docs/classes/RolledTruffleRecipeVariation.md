[Home](../README.md) > RolledTruffleRecipeVariation

# Class: RolledTruffleRecipeVariation

A view of a rolled truffle recipe variation with all references resolved.

**Extends:** [`ConfectionRecipeVariationBase<IRolledTruffleRecipe, IRolledTruffleRecipeVariationEntity>`](ConfectionRecipeVariationBase.md)
