[Home](../README.md) > BarTruffleRecipe

# Class: BarTruffleRecipe

A resolved view of a bar truffle confection recipe with navigation capabilities.
Immutable - does not allow modification of underlying data.

**Extends:** [`ConfectionBase<IBarTruffleRecipeVariation, BarTruffleRecipeEntity>`](ConfectionBase.md)
...
[confectionType](./BarTruffleRecipe.confectionType.md)
...
[frameDimensions](./BarTruffleRecipe.frameDimensions.md)
...
[fillings](./BarTruffleRecipe.fillings.md)
...
[procedures](./BarTruffleRecipe.procedures.md)
...
[enrobingChocolate](./BarTruffleRecipe.enrobingChocolate.md)
...
[entity](./BarTruffleRecipe.entity.md)
...
[create(context, id, confection)](./BarTruffleRecipe.create.md)
