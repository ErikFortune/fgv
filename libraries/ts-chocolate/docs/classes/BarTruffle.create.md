[Home](../README.md) > [BarTruffle](./BarTruffle.md) > create
...
```typescript
static create(context: IConfectionContext, id: ConfectionId, confection: BarTruffleRecipeEntity): Result<BarTruffle>;
```
...
Result&lt;[BarTruffle](BarTruffle.md)&gt;
