[Home](../README.md) > BarTruffleRecipeVariation

# Class: BarTruffleRecipeVariation

A resolved view of a bar truffle recipe variation with all references resolved.

**Extends:** [`ConfectionRecipeVariationBase<IBarTruffleRecipe, IBarTruffleRecipeVariationEntity>`](ConfectionRecipeVariationBase.md)
