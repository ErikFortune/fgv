[Home](../README.md) > MoldedBonBonRecipeVariation

# Class: MoldedBonBonRecipeVariation

A resolved view of a molded bonbon variation with all references resolved.

**Extends:** [`ConfectionRecipeVariationBase<IMoldedBonBonRecipe, IMoldedBonBonRecipeVariationEntity>`](ConfectionRecipeVariationBase.md)
