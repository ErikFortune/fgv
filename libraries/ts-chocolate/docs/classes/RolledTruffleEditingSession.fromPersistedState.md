...
```typescript
static fromPersistedState(baseConfection: RolledTruffle, history: ISerializedEditingHistoryEntity<IProducedRolledTruffleEntity>, context: ISessionContext, params?: IConfectionEditingSessionParams): Result<RolledTruffleEditingSession>;
```
