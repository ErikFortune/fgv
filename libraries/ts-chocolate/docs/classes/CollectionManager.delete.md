[Home](../README.md) > [CollectionManager](./CollectionManager.md) > delete
...
```typescript
delete(collectionId: CollectionId): Result<AggregatedResultMapEntry<CollectionId, TBaseId, TItem, ICollectionRuntimeMetadata>>;
```
