...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [RuntimeRecipe](./ts-chocolate.runtime.runtimerecipe.md) &gt; [getIngredientIds](./ts-chocolate.runtime.runtimerecipe.getingredientids.md)

## Runtime.RuntimeRecipe.getIngredientIds() method
