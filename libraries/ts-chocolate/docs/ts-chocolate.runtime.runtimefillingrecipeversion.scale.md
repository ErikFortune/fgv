...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [RuntimeFillingRecipeVersion](./ts-chocolate.runtime.runtimefillingrecipeversion.md) &gt; [scale](./ts-chocolate.runtime.runtimefillingrecipeversion.scale.md)

## Runtime.RuntimeFillingRecipeVersion.scale() method
