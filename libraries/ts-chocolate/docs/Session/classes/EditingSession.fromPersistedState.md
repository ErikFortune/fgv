[Home](../../README.md) > [Session](../README.md) > [EditingSession](./EditingSession.md) > fromPersistedState
...
<tr><td>baseRecipe</td><td>IFillingRecipeVersion</td><td>Runtime recipe version to associate with the session</td></tr>
</tbody></table>
