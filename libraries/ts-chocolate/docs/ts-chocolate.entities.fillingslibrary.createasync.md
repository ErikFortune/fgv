...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [FillingsLibrary](./ts-chocolate.entities.fillingslibrary.md) &gt; [createAsync](./ts-chocolate.entities.fillingslibrary.createasync.md)

## Entities.FillingsLibrary.createAsync() method
