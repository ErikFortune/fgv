[Home](../../README.md) > [UserLibrary](../README.md) > [BarTruffleEditingSession](./BarTruffleEditingSession.md) > fromPersistedState
...
```typescript
static fromPersistedState(baseConfection: T, persistedEntity: IConfectionSessionEntity, context: ISessionContext, params?: IConfectionEditingSessionParams): Result<BarTruffleEditingSession<T>>;
```
