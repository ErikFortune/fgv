...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [SessionLibrary](./ts-chocolate.entities.sessionlibrary.md) &gt; [getSessionsForConfection](./ts-chocolate.entities.sessionlibrary.getsessionsforconfection.md)

## Entities.SessionLibrary.getSessionsForConfection() method
