...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Runtime](./ts-chocolate.runtime.md) &gt; [ISessionContext](./ts-chocolate.runtime.isessioncontext.md) &gt; [createFillingSession](./ts-chocolate.runtime.isessioncontext.createfillingsession.md)

## Runtime.ISessionContext.createFillingSession() method
