...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Fillings](./ts-chocolate.fillings.md) &gt; [scaleVersion](./ts-chocolate.fillings.scaleversion.md)

## Fillings.scaleVersion() function
...
_(Optional)_ Optional [scaling options](./ts-chocolate.fillings.iversionscaleoptions.md)
