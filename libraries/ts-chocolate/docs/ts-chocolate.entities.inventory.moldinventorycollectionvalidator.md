...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Entities](./ts-chocolate.entities.md) &gt; [Inventory](./ts-chocolate.entities.inventory.md) &gt; [MoldInventoryCollectionValidator](./ts-chocolate.entities.inventory.moldinventorycollectionvalidator.md)

## Entities.Inventory.MoldInventoryCollectionValidator type
