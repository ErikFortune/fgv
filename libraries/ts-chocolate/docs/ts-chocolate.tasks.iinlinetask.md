...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [Tasks](./ts-chocolate.tasks.md) &gt; [IInlineTask](./ts-chocolate.tasks.iinlinetask.md)

## Tasks.IInlineTask interface
...
[params](./ts-chocolate.tasks.iinlinetask.params.md)
...
[task](./ts-chocolate.tasks.iinlinetask.task.md)
