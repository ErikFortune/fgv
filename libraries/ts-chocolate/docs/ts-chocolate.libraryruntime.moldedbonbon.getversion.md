...
[Home](./index.md) &gt; [@fgv/ts-chocolate](./ts-chocolate.md) &gt; [LibraryRuntime](./ts-chocolate.libraryruntime.md) &gt; [MoldedBonBon](./ts-chocolate.libraryruntime.moldedbonbon.md) &gt; [getVersion](./ts-chocolate.libraryruntime.moldedbonbon.getversion.md)

## LibraryRuntime.MoldedBonBon.getVersion() method
