[Home](../../README.md) > [LibraryData](../README.md) > [IRuntimeCollection](./IRuntimeCollection.md) > sourceItem

## IRuntimeCollection.sourceItem property
...
```typescript
readonly sourceItem: FileTreeItem;
```
