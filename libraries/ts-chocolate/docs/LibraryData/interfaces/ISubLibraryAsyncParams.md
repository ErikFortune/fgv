[Home](../../README.md) > [LibraryData](../README.md) > ISubLibraryAsyncParams

# Interface: ISubLibraryAsyncParams

Parameters for creating a sub-library instance asynchronously.

Extends LibraryData.ISubLibraryParams | ISubLibraryParams with encryption support for decrypting
encrypted collections during async loading.

**Extends:** [`ISubLibraryParams<TLibrary, TEntryInit>`](../../interfaces/ISubLibraryParams.md)
...
[encryption](./ISubLibraryAsyncParams.encryption.md)
