[Home](../../../README.md) > [Runtime](../../README.md) > [Session](../README.md) > [MoldedBonBonEditingSession](./MoldedBonBonEditingSession.md) > fromPersistedState
...
```typescript
static fromPersistedState(baseConfection: MoldedBonBon, history: ISerializedEditingHistoryEntity<IProducedMoldedBonBonEntity>, context: ISessionContext, params?: IConfectionEditingSessionParams): Result<MoldedBonBonEditingSession>;
```
...
<tbody>
<tr><td>baseConfection</td><td>MoldedBonBon</td><td>The source molded bonbon confection</td></tr>
