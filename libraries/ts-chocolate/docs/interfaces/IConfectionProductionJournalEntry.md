[Home](../README.md) > IConfectionProductionJournalEntry

# Interface: IConfectionProductionJournalEntry

Materialized journal entry for confection production sessions.

**Extends:** [`IJournalEntryBase<IConfectionBase, IConfectionVersionBase, ConfectionVersionId, IConfectionProductionJournalEntryEntity>`](IJournalEntryBase.md)
...
[IConfectionProductionJournalEntryEntity](IConfectionProductionJournalEntryEntity.md)
