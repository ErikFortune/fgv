[Home](../README.md) > IBarTruffleVersion

# Interface: IBarTruffleVersion

Runtime confection version narrowed to bar truffle type.

**Extends:** [`IConfectionVersionBase<IBarTruffle, IBarTruffleVersionEntity>`](IConfectionVersionBase.md)
...
[IBarTruffleVersionEntity](IBarTruffleVersionEntity.md)
