[Home](../README.md) > IRolledTruffleRecipeVariation

# Interface: IRolledTruffleRecipeVariation

Runtime confection variation narrowed to rolled truffle type.

**Extends:** [`IConfectionRecipeVariationBase<IRolledTruffleRecipe, IRolledTruffleRecipeVariationEntity>`](IConfectionRecipeVariationBase.md)
...
[IRolledTruffleRecipe](IRolledTruffleRecipe.md)
...
[IRolledTruffleRecipeVariationEntity](IRolledTruffleRecipeVariationEntity.md)
