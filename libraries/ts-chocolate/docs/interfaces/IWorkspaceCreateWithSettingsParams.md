[Home](../README.md) > IWorkspaceCreateWithSettingsParams

# Interface: IWorkspaceCreateWithSettingsParams

Parameters for creating a workspace with pre-created settings manager.
Used by platform initialization flow.

**Extends:** [`IWorkspaceCreateParams`](IWorkspaceCreateParams.md)
...
[settings](./IWorkspaceCreateWithSettingsParams.settings.md)
...
[ISettingsManager](ISettingsManager.md)
