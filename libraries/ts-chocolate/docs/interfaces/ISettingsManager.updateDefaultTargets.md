[Home](../README.md) > [ISettingsManager](./ISettingsManager.md) > updateDefaultTargets

## ISettingsManager.updateDefaultTargets() method
...
Result&lt;[IDefaultCollectionTargets](IDefaultCollectionTargets.md)&gt;
