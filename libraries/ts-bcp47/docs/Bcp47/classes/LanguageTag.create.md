[Home](../../README.md) > [Bcp47](../README.md) > [LanguageTag](./LanguageTag.md) > create

## LanguageTag.create() method

Creates a new Bcp47.LanguageTag | language tag from a supplied `string`
tag or Bcp47.Subtags | subtags using optional configuration,
if supplied.
...
<tbody>
<tr><td>from</td><td>string | ISubtags</td><td>The `string` tag or Bcp47.Subtags | subtags from
which the Bcp47.LanguageTag | language tag is te be constructed.</td></tr>
