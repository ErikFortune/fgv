...
[Home](./index.md) &gt; [@fgv/ts-res-ui-components](./ts-res-ui-components.md) &gt; [FilterTools](./ts-res-ui-components.filtertools.md) &gt; [IFilterResult](./ts-res-ui-components.filtertools.ifilterresult.md)

## FilterTools.IFilterResult interface
...
[error?](./ts-res-ui-components.filtertools.ifilterresult.error.md)
...
[filteredResources](./ts-res-ui-components.filtertools.ifilterresult.filteredresources.md)
...
[processedResources?](./ts-res-ui-components.filtertools.ifilterresult.processedresources.md)
...
[success](./ts-res-ui-components.filtertools.ifilterresult.success.md)
...
[warnings](./ts-res-ui-components.filtertools.ifilterresult.warnings.md)
