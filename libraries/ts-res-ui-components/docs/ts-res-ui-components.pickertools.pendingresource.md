...
[Home](./index.md) &gt; [@fgv/ts-res-ui-components](./ts-res-ui-components.md) &gt; [PickerTools](./ts-res-ui-components.pickertools.md) &gt; [PendingResource](./ts-res-ui-components.pickertools.pendingresource.md)

## PickerTools.PendingResource interface
...
[displayName?](./ts-res-ui-components.pickertools.pendingresource.displayname.md)
...
[id](./ts-res-ui-components.pickertools.pendingresource.id.md)
...
[resourceData?](./ts-res-ui-components.pickertools.pendingresource.resourcedata.md)
...
[resourceType?](./ts-res-ui-components.pickertools.pendingresource.resourcetype.md)
...
[type](./ts-res-ui-components.pickertools.pendingresource.type.md)
