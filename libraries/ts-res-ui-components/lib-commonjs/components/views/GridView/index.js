...
const GridView = ({
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          gridConfig.title || 'Resource Grid'
        )
      ),
      react_1.default.createElement(
        'div',
  ...
  return react_1.default.createElement(
    ...
    gridConfig.description &&
      react_1.default.createElement('p', { className: 'text-gray-600 mb-6' }, gridConfig.description),
    react_1.default.createElement(
      'div',
      ...
      react_1.default.createElement(ResourceGrid_1.ResourceGrid, {
        gridConfig: gridConfig,
