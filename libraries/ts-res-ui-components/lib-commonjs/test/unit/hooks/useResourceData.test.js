...
const createMockProcessedResources = () => ({
  system: {
    resourceManager: {},
    qualifierTypes: {},
    qualifiers: {},
...
const createMockConfiguration = () => (0, tsResIntegration_1.getDefaultSystemConfiguration)();
const createMockProcessedResourcesWithUpdatedSystem = (originalResources) => ({
  ...originalResources,
  system: {
    ...originalResources.system,
    // Simulate updated resource manager with new candidates
    resourceManager: { ...originalResources.system.resourceManager, updated: true }
  },
...
describe('useResourceData', () => {
  describe('updateProcessedResources', () => {
    test('should preserve activeConfiguration when updating processed resources', () => {
      const { result } = (0, react_1.renderHook)(() => (0, useResourceData_1.useResourceData)({}));
    ...
    test('should handle updating resources when no previous configuration exists', () => {
      const { result } = (0, react_1.renderHook)(() => (0, useResourceData_1.useResourceData)({}));
      const mockResources = createMockProcessedResources();
      (0, react_1.act)(() => {
  ...
  describe('resource editing workflow regression test', () => {
    test('should preserve updated resource system when applying edits with extended metadata', () => {
      ...
      expect(finalState.system.resourceManager.updated).toBe(true); // System updated
...
//# sourceMappingURL=useResourceData.test.js.map
