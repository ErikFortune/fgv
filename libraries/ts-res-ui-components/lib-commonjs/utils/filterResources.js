 ...
 * @public
 */
const createFilteredResourceManagerSimple = async (
  originalSystem,
  partialContext,
  ...
  if (!originalSystem?.resourceManager) {
    return (0, ts_utils_1.fail)('Original system or resourceManager is undefined');
  }
  ...
  return resourceManagerBuilder
                ...
                .onSuccess((compiledCollection) => {
                  ...
                  return ts_res_1.Runtime.ResourceResolver.create({
                    ...
                    .onSuccess((resolver) => {
                      ...
                      return (0, ts_utils_1.succeed)(processedResources);
                    });
                });
            });
        });
    ...
    .onFailure((error) => {
      ...
      return (0, ts_utils_1.fail)(`Failed to create filtered resource manager: ${error}`);
    });
};
