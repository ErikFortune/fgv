...
[Home](./index.md) &gt; [@fgv/ts-extras](./ts-extras.md) &gt; [Crypto\_2](./ts-extras.crypto_2.md) &gt; [KeyStore](./ts-extras.crypto_2.keystore.md) &gt; [KeyStore](./ts-extras.crypto_2.keystore.keystore.md)

## Crypto\_2.KeyStore.KeyStore class
...
[isDirty](./ts-extras.crypto_2.keystore.keystore.isdirty.md)
...
[isUnlocked](./ts-extras.crypto_2.keystore.keystore.isunlocked.md)
...
[state](./ts-extras.crypto_2.keystore.keystore.state.md)
...
[KeyStoreLockState](./ts-extras.crypto_2.keystore.keystorelockstate.md)
...
[addSecret(name, options)](./ts-extras.crypto_2.keystore.keystore.addsecret.md)
...
[changePassword(currentPassword, newPassword)](./ts-extras.crypto_2.keystore.keystore.changepassword.md)
...
[create(params)](./ts-extras.crypto_2.keystore.keystore.create.md)
...
[getEncryptionConfig()](./ts-extras.crypto_2.keystore.keystore.getencryptionconfig.md)
...
[getSecret(name)](./ts-extras.crypto_2.keystore.keystore.getsecret.md)
...
[getSecretProvider()](./ts-extras.crypto_2.keystore.keystore.getsecretprovider.md)
...
[hasSecret(name)](./ts-extras.crypto_2.keystore.keystore.hassecret.md)
...
[importSecret(name, key, options)](./ts-extras.crypto_2.keystore.keystore.importsecret.md)
...
[initialize(password)](./ts-extras.crypto_2.keystore.keystore.initialize.md)
...
[listSecrets()](./ts-extras.crypto_2.keystore.keystore.listsecrets.md)
...
[lock(force)](./ts-extras.crypto_2.keystore.keystore.lock.md)
...
[open(params)](./ts-extras.crypto_2.keystore.keystore.open.md)
...
[removeSecret(name)](./ts-extras.crypto_2.keystore.keystore.removesecret.md)
...
[renameSecret(oldName, newName)](./ts-extras.crypto_2.keystore.keystore.renamesecret.md)
...
[save(password)](./ts-extras.crypto_2.keystore.keystore.save.md)
...
[unlock(password)](./ts-extras.crypto_2.keystore.keystore.unlock.md)
