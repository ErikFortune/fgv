...
|  --- | --- | --- | --- |
|  [brand?](./ts-utils.conversion.converter.brand.md) | <code>readonly</code> | string | _(Optional)_ Returns the brand for a branded type. |
|  [isOptional](./ts-utils.conversion.converter.isoptional.md) | <code>readonly</code> | boolean | Indicates whether this element is explicitly optional. |
