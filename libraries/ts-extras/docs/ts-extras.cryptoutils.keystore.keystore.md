...
[Home](./index.md) &gt; [@fgv/ts-extras](./ts-extras.md) &gt; [CryptoUtils](./ts-extras.cryptoutils.md) &gt; [KeyStore](./ts-extras.cryptoutils.keystore.md) &gt; [KeyStore](./ts-extras.cryptoutils.keystore.keystore.md)
...
[isDirty](./ts-extras.cryptoutils.keystore.keystore.isdirty.md)
...
[isUnlocked](./ts-extras.cryptoutils.keystore.keystore.isunlocked.md)
...
[state](./ts-extras.cryptoutils.keystore.keystore.state.md)
...
[addSecret(name, options)](./ts-extras.cryptoutils.keystore.keystore.addsecret.md)
...
[changePassword(currentPassword, newPassword)](./ts-extras.cryptoutils.keystore.keystore.changepassword.md)
...
[create(params)](./ts-extras.cryptoutils.keystore.keystore.create.md)
...
[getEncryptionConfig()](./ts-extras.cryptoutils.keystore.keystore.getencryptionconfig.md)
...
[getSecret(name)](./ts-extras.cryptoutils.keystore.keystore.getsecret.md)
...
[getSecretProvider()](./ts-extras.cryptoutils.keystore.keystore.getsecretprovider.md)
...
[hasSecret(name)](./ts-extras.cryptoutils.keystore.keystore.hassecret.md)
...
[importSecret(name, key, options)](./ts-extras.cryptoutils.keystore.keystore.importsecret.md)
...
[initialize(password)](./ts-extras.cryptoutils.keystore.keystore.initialize.md)
...
[listSecrets()](./ts-extras.cryptoutils.keystore.keystore.listsecrets.md)
...
[lock(force)](./ts-extras.cryptoutils.keystore.keystore.lock.md)
...
[open(params)](./ts-extras.cryptoutils.keystore.keystore.open.md)
...
[removeSecret(name)](./ts-extras.cryptoutils.keystore.keystore.removesecret.md)
...
[renameSecret(oldName, newName)](./ts-extras.cryptoutils.keystore.keystore.renamesecret.md)
...
[save(password)](./ts-extras.cryptoutils.keystore.keystore.save.md)
...
[unlock(password)](./ts-extras.cryptoutils.keystore.keystore.unlock.md)
