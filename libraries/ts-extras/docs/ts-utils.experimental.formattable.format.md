...
[Home](./index.md) &gt; [@fgv/ts-utils](./ts-utils.md) &gt; [Experimental](./ts-utils.experimental.md) &gt; [Formattable](./ts-utils.experimental.formattable.md) &gt; [format](./ts-utils.experimental.formattable.format.md)
