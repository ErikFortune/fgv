...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Runtime](./ts-res.runtime.md) &gt; [ContextQualifierProvider](./ts-res.runtime.contextqualifierprovider.md)

## Runtime.ContextQualifierProvider class
...
```
**Implements:** [IContextQualifierProvider](./ts-res.runtime.icontextqualifierprovider.md)
...
[qualifiers](./ts-res.runtime.contextqualifierprovider.qualifiers.md)
...
[get(nameOrIndexOrQualifier)](./ts-res.runtime.contextqualifierprovider.get.md)
...
[getNames()](./ts-res.runtime.contextqualifierprovider.getnames.md)
...
[getValidated(nameOrIndexOrQualifier)](./ts-res.runtime.contextqualifierprovider.getvalidated.md)
...
[has(name)](./ts-res.runtime.contextqualifierprovider.has.md)
