...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [validateContextValue](./ts-res.qualifiers.qualifiertype.validatecontextvalue.md)

## Qualifiers.QualifierType.validateContextValue() method
