...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [isValidName](./ts-res.qualifiers.qualifiertype.isvalidname.md)

## Qualifiers.QualifierType.isValidName() method
