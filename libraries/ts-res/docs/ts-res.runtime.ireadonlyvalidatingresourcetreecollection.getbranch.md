...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Runtime](./ts-res.runtime.md) &gt; [IReadOnlyValidatingResourceTreeCollection](./ts-res.runtime.ireadonlyvalidatingresourcetreecollection.md) &gt; [getBranch](./ts-res.runtime.ireadonlyvalidatingresourcetreecollection.getbranch.md)

## Runtime.IReadOnlyValidatingResourceTreeCollection.getBranch() method
