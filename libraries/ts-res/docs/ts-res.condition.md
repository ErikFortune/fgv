...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Condition](./ts-res.condition.md)
...
[(constructor)({ qualifier, value, operator, priority, scoreAsDefault, index })](./ts-res.condition._constructor_.md)
...
[\_collectible](./ts-res.condition._collectible.md)
...
[index](./ts-res.condition.index.md)
...
[operator](./ts-res.condition.operator.md)
...
[priority](./ts-res.condition.priority.md)
...
[qualifier](./ts-res.condition.qualifier.md)
...
[scoreAsDefault?](./ts-res.condition.scoreasdefault.md)
...
[value](./ts-res.condition.value.md)
...
[canMatchPartialContext(context, options)](./ts-res.condition.canmatchpartialcontext.md)
...
[compare(c1, c2)](./ts-res.condition.compare.md)
...
[create(decl)](./ts-res.condition.create.md)
...
[getContextMatch(context, options)](./ts-res.condition.getcontextmatch.md)
...
[getKeyForDecl(decl)](./ts-res.condition.getkeyfordecl.md)
...
[setIndex(index)](./ts-res.condition.setindex.md)
...
[toChildConditionDecl(options)](./ts-res.condition.tochildconditiondecl.md)
...
[toCompiled(options)](./ts-res.condition.tocompiled.md)
...
[toKey()](./ts-res.condition.tokey.md)
...
[toLooseConditionDecl(options)](./ts-res.condition.tolooseconditiondecl.md)
...
[toString()](./ts-res.condition.tostring.md)
...
[toToken(terse)](./ts-res.condition.totoken.md)
...
[toValueOrChildConditionDecl(options)](./ts-res.condition.tovalueorchildconditiondecl.md)
