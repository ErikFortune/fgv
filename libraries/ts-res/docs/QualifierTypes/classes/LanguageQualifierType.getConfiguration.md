[Home](../../README.md) > [QualifierTypes](../README.md) > [LanguageQualifierType](./LanguageQualifierType.md) > getConfiguration

## LanguageQualifierType.getConfiguration() method
...
```typescript
getConfiguration(): Result<ISystemLanguageQualifierTypeConfig>;
```
