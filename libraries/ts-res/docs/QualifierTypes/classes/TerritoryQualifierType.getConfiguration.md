[Home](../../README.md) > [QualifierTypes](../README.md) > [TerritoryQualifierType](./TerritoryQualifierType.md) > getConfiguration

## TerritoryQualifierType.getConfiguration() method
...
```typescript
getConfiguration(): Result<ISystemTerritoryQualifierTypeConfig>;
```
