...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [QualifierType](./ts-res.qualifiertypes.qualifiertype.md) &gt; [isValidConditionValue](./ts-res.qualifiertypes.qualifiertype.isvalidconditionvalue.md)

## QualifierTypes.QualifierType.isValidConditionValue() method
