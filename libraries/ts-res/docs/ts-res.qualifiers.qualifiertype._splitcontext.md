...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [\_splitContext](./ts-res.qualifiers.qualifiertype._splitcontext.md)

## Qualifiers.QualifierType.\_splitContext() method
