...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Decisions](./ts-res.decisions.md) &gt; [AbstractDecision](./ts-res.decisions.abstractdecision.md) &gt; [getAbstractKey](./ts-res.decisions.abstractdecision.getabstractkey.md)

## Decisions.AbstractDecision.getAbstractKey() method
