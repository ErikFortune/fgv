[Home](../README.md) > [IResourceResolver](./IResourceResolver.md) > resolveComposedResourceValue
...
<tbody>
<tr><td>resource</td><td>string</td><td>The string id of the resource to resolve.</td></tr>
</tbody></table>
