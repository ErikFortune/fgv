[Home](../README.md) > [QualifierType](./QualifierType.md) > _matchOne

## QualifierType._matchOne() method
...
```typescript
_matchOne(condition: QualifierConditionValue, context: QualifierContextValue, operator: ConditionOperator): QualifierMatchScore;
```
...
<tr><td>context</td><td>QualifierContextValue</td><td>The QualifierContextValue | context value to match.</td></tr>
