[Home](../README.md) > [ResourceManagerBuilder](./ResourceManagerBuilder.md) > clone
...
<tbody>
<tr><td>options</td><td>IResourceManagerCloneOptions</td><td>Options for the cloning operation:
  ...
  - `candidates`: Optional candidate edits to apply during cloning</td></tr>
</tbody></table>
