...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Conditions](./ts-res.conditions.md) &gt; [Condition](./ts-res.conditions.condition.md) &gt; [toCompiled](./ts-res.conditions.condition.tocompiled.md)

## Conditions.Condition.toCompiled() method
