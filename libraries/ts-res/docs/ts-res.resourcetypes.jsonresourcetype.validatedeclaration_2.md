...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [ResourceTypes](./ts-res.resourcetypes.md) &gt; [JsonResourceType](./ts-res.resourcetypes.jsonresourcetype.md) &gt; [validateDeclaration](./ts-res.resourcetypes.jsonresourcetype.validatedeclaration_2.md)
