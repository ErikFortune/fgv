...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [matches](./ts-res.qualifiers.qualifiertype.matches.md)

## Qualifiers.QualifierType.matches() method
