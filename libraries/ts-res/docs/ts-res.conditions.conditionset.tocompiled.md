...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Conditions](./ts-res.conditions.md) &gt; [ConditionSet](./ts-res.conditions.conditionset.md) &gt; [toCompiled](./ts-res.conditions.conditionset.tocompiled.md)

## Conditions.ConditionSet.toCompiled() method
