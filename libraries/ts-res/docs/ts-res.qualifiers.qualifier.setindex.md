...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [Qualifier](./ts-res.qualifiers.qualifier.md) &gt; [setIndex](./ts-res.qualifiers.qualifier.setindex.md)

## Qualifiers.Qualifier.setIndex() method
