...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [LiteralQualifierType](./ts-res.qualifiertypes.literalqualifiertype.md) &gt; [\_matchOne](./ts-res.qualifiertypes.literalqualifiertype._matchone.md)

## QualifierTypes.LiteralQualifierType.\_matchOne() method
