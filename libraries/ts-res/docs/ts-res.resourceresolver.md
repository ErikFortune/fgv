...
[qualifiers](./ts-res.resourceresolver.qualifiers.md)
...
[resolveAllResourceCandidates(resource)](./ts-res.resourceresolver.resolveallresourcecandidates_1.md)
...
[resolveComposedResourceTree(node, options)](./ts-res.resourceresolver.resolvecomposedresourcetree.md)
...
[resolveComposedResourceValue(resource)](./ts-res.resourceresolver.resolvecomposedresourcevalue_1.md)
...
[resolveResource(resource)](./ts-res.resourceresolver.resolveresource_1.md)
...
[withContext(context)](./ts-res.resourceresolver.withcontext.md)
