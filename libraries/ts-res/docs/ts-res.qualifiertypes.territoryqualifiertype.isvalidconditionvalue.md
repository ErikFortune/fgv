...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [TerritoryQualifierType](./ts-res.qualifiertypes.territoryqualifiertype.md) &gt; [isValidConditionValue](./ts-res.qualifiertypes.territoryqualifiertype.isvalidconditionvalue.md)

## QualifierTypes.TerritoryQualifierType.isValidConditionValue() method
