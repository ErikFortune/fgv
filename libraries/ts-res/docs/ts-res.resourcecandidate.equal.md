...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [ResourceCandidate](./ts-res.resourcecandidate.md) &gt; [equal](./ts-res.resourcecandidate.equal.md)

## ResourceCandidate.equal() method
