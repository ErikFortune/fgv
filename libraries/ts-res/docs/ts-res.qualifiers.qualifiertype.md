...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md)

## Qualifiers.QualifierType class
...
[(constructor)({ name, index, allowContextList })](./ts-res.qualifiers.qualifiertype._constructor_.md)
...
[\_allowContextList](./ts-res.qualifiers.qualifiertype._allowcontextlist.md)
...
[\_collectible](./ts-res.qualifiers.qualifiertype._collectible.md)
...
[index](./ts-res.qualifiers.qualifiertype.index.md)
...
[key](./ts-res.qualifiers.qualifiertype.key.md)
...
[name](./ts-res.qualifiers.qualifiertype.name.md)
...
[\_matchList(condition, context, operator)](./ts-res.qualifiers.qualifiertype._matchlist.md)
...
[\_matchOne(condition, context, operator)](./ts-res.qualifiers.qualifiertype._matchone.md)
...
[\_splitContext(value)](./ts-res.qualifiers.qualifiertype._splitcontext.md)
...
[compare(t1, t2)](./ts-res.qualifiers.qualifiertype.compare.md)
...
[isValidConditionValue(value)](./ts-res.qualifiers.qualifiertype.isvalidconditionvalue.md)
...
[isValidContextValue(value)](./ts-res.qualifiers.qualifiertype.isvalidcontextvalue.md)
...
[isValidIndex(index)](./ts-res.qualifiers.qualifiertype.isvalidindex.md)
...
[isValidName(name)](./ts-res.qualifiers.qualifiertype.isvalidname.md)
...
[matches(condition, context, operator)](./ts-res.qualifiers.qualifiertype.matches.md)
...
[setIndex(index)](./ts-res.qualifiers.qualifiertype.setindex.md)
...
[validateCondition(value, operator)](./ts-res.qualifiers.qualifiertype.validatecondition.md)
...
[validateContextValue(value)](./ts-res.qualifiers.qualifiertype.validatecontextvalue.md)
