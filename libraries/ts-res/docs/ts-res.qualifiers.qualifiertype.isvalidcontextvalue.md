...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [isValidContextValue](./ts-res.qualifiers.qualifiertype.isvalidcontextvalue.md)

## Qualifiers.QualifierType.isValidContextValue() method
