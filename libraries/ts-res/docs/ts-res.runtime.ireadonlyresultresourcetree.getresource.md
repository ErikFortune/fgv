...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Runtime](./ts-res.runtime.md) &gt; [IReadOnlyResultResourceTree](./ts-res.runtime.ireadonlyresultresourcetree.md) &gt; [getResource](./ts-res.runtime.ireadonlyresultresourcetree.getresource.md)

## Runtime.IReadOnlyResultResourceTree.getResource() method
