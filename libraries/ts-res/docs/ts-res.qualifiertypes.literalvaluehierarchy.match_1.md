...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [LiteralValueHierarchy](./ts-res.qualifiertypes.literalvaluehierarchy.md) &gt; [match](./ts-res.qualifiertypes.literalvaluehierarchy.match_1.md)
...
_(Optional)_ The operator used for matching (not used in this implementation).
