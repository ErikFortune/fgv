...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [QualifierType](./ts-res.qualifiertypes.qualifiertype.md) &gt; [isValidContextValue](./ts-res.qualifiertypes.qualifiertype.isvalidcontextvalue.md)

## QualifierTypes.QualifierType.isValidContextValue() method
