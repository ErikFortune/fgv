...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierType](./ts-res.qualifiers.qualifiertype.md) &gt; [\_matchOne](./ts-res.qualifiers.qualifiertype._matchone.md)

## Qualifiers.QualifierType.\_matchOne() method
