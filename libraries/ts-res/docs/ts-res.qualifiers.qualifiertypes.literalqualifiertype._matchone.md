...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [Qualifiers](./ts-res.qualifiers.md) &gt; [QualifierTypes](./ts-res.qualifiers.qualifiertypes.md) &gt; [LiteralQualifierType](./ts-res.qualifiers.qualifiertypes.literalqualifiertype.md) &gt; [\_matchOne](./ts-res.qualifiers.qualifiertypes.literalqualifiertype._matchone.md)

## Qualifiers.QualifierTypes.LiteralQualifierType.\_matchOne() method
