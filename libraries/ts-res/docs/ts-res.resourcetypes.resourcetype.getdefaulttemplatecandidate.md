...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [ResourceTypes](./ts-res.resourcetypes.md) &gt; [ResourceType](./ts-res.resourcetypes.resourcetype.md) &gt; [getDefaultTemplateCandidate](./ts-res.resourcetypes.resourcetype.getdefaulttemplatecandidate.md)

## ResourceTypes.ResourceType.getDefaultTemplateCandidate() method
