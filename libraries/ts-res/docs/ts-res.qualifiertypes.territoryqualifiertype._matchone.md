...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [QualifierTypes](./ts-res.qualifiertypes.md) &gt; [TerritoryQualifierType](./ts-res.qualifiertypes.territoryqualifiertype.md) &gt; [\_matchOne](./ts-res.qualifiertypes.territoryqualifiertype._matchone.md)

## QualifierTypes.TerritoryQualifierType.\_matchOne() method
