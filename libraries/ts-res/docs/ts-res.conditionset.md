...
[Home](./index.md) &gt; [@fgv/ts-res](./ts-res.md) &gt; [ConditionSet](./ts-res.conditionset.md)
...
[(constructor)(params)](./ts-res.conditionset._constructor_.md)
...
[\_collectible](./ts-res.conditionset._collectible.md)
...
[conditions](./ts-res.conditionset.conditions.md)
...
[index](./ts-res.conditionset.index.md)
...
[key](./ts-res.conditionset.key.md)
...
[size](./ts-res.conditionset.size.md)
...
[UnconditionalKey](./ts-res.conditionset.unconditionalkey.md)
...
[canMatchPartialContext(context, options)](./ts-res.conditionset.canmatchpartialcontext.md)
...
[compare(cs1, cs2)](./ts-res.conditionset.compare.md)
...
[create(params)](./ts-res.conditionset.create.md)
...
[getKeyForDecl(decl)](./ts-res.conditionset.getkeyfordecl.md)
...
[toCompiled(options)](./ts-res.conditionset.tocompiled.md)
...
[toConditionSetArrayDecl(options)](./ts-res.conditionset.toconditionsetarraydecl.md)
...
[toConditionSetRecordDecl(options)](./ts-res.conditionset.toconditionsetrecorddecl.md)
...
[toHash()](./ts-res.conditionset.tohash.md)
...
[toKey()](./ts-res.conditionset.tokey.md)
...
[toString()](./ts-res.conditionset.tostring.md)
...
[toToken(terse)](./ts-res.conditionset.totoken.md)
