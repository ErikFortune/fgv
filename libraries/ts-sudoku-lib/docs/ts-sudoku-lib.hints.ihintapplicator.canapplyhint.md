...
[Home](./index.md) &gt; [@fgv/ts-sudoku-lib](./ts-sudoku-lib.md) &gt; [Hints](./ts-sudoku-lib.hints.md) &gt; [IHintApplicator](./ts-sudoku-lib.hints.ihintapplicator.md) &gt; [canApplyHint](./ts-sudoku-lib.hints.ihintapplicator.canapplyhint.md)

## Hints.IHintApplicator.canApplyHint() method
