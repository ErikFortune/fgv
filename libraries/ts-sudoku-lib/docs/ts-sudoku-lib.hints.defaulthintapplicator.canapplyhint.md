...
[Home](./index.md) &gt; [@fgv/ts-sudoku-lib](./ts-sudoku-lib.md) &gt; [Hints](./ts-sudoku-lib.hints.md) &gt; [DefaultHintApplicator](./ts-sudoku-lib.hints.defaulthintapplicator.md) &gt; [canApplyHint](./ts-sudoku-lib.hints.defaulthintapplicator.canapplyhint.md)

## Hints.DefaultHintApplicator.canApplyHint() method
