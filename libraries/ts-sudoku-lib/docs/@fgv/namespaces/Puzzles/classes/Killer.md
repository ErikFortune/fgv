...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Puzzles](../README.md) / Killer
...
> `static` **create**(`desc`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`Puzzle`](../../../../classes/Puzzle.md)\>
