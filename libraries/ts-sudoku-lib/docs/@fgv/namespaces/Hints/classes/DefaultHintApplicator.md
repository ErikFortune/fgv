...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Hints](../README.md) / DefaultHintApplicator
...
> **canApplyHint**(`hint`, `puzzle`, `state`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<`void`\>
