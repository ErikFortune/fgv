...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Hints](../README.md) / HiddenSinglesProvider
...
> `static` **create**(): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<`HiddenSinglesProvider`\>

Static factory method to create a new HiddenSinglesProvider.

#### Returns

[`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<`HiddenSinglesProvider`\>
