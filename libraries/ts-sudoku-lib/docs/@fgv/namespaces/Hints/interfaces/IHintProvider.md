...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Hints](../README.md) / IHintProvider
...
> **generateHints**(`puzzle`, `state`, `options?`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<readonly [`IHint`](IHint.md)[]\>
