...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Hints](../README.md) / IHintExplanationProvider
...
> **generateExplanations**(`hint`, `puzzle`, `state`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<readonly [`IHintExplanation`](IHintExplanation.md)[]\>
...
[`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<readonly [`IHintExplanation`](IHintExplanation.md)[]\>
