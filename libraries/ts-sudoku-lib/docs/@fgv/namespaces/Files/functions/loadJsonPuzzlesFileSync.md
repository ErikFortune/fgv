...
[@fgv/ts-sudoku-lib](../../../../README.md) / [Files](../README.md) / loadJsonPuzzlesFileSync

# Function: loadJsonPuzzlesFileSync()

> **loadJsonPuzzlesFileSync**(`path`): [`Result`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`IPuzzlesFile`](../namespaces/Model/interfaces/IPuzzlesFile.md)\>
