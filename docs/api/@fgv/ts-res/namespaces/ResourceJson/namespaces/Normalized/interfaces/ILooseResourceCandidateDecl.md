...
[@fgv Monorepo API Documentation](../../../../../../../README.md) / [@fgv/ts-res](../../../../../README.md) / [ResourceJson](../../../README.md) / [Normalized](../README.md) / ILooseResourceCandidateDecl

# Interface: ILooseResourceCandidateDecl

Normalized non-validated loose declaration of a [resource candidate](../../../../../classes/ResourceCandidate.md).
...
| <a id="resourcetypename"></a> `resourceTypeName?` | `readonly` | `string` | The type of the resource. |
