...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-web-extras](../../../README.md) / [FileTreeHelpers](../README.md) / fromDirectoryUpload

# Function: fromDirectoryUpload()

> **fromDirectoryUpload**(`fileList`, `params?`): `Promise`\<[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`FileTree_2`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-json-base/docs)\<`string`\>\>\>
...
`Promise`\<[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`FileTree_2`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-json-base/docs)\<`string`\>\>\>
