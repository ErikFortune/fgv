...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-utils](../README.md) / IResult
...
> **thenOnFailure**(`cb`): [`AsyncResult`](../classes/AsyncResult.md)\<`T`\>

Calls a supplied [async failure continuation](../type-aliases/AsyncFailureContinuation.md) if
the operation failed, bridging into an [AsyncResult](../classes/AsyncResult.md) chain.
...
An [AsyncResult](../classes/AsyncResult.md) wrapping the async continuation result, or
propagating the success value from this result.

#### Remarks

If the async callback rejects, the rejection is caught and converted
to a [Failure](../classes/Failure.md).

***

### thenOnSuccess()

> **thenOnSuccess**\<`TN`\>(`cb`): [`AsyncResult`](../classes/AsyncResult.md)\<`TN`\>

Calls a supplied [async success continuation](../type-aliases/AsyncSuccessContinuation.md) if
the operation was a success, bridging into an [AsyncResult](../classes/AsyncResult.md) chain.
...
[`AsyncResult`](../classes/AsyncResult.md)\<`TN`\>
