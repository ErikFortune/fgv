...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-utils](../README.md) / succeedsWithDetail

# Function: succeedsWithDetail()

> **succeedsWithDetail**\<`T`, `TD`\>(`value`, `detail?`): [`DetailedSuccess`](../classes/DetailedSuccess.md)\<`T`, `TD`\>
