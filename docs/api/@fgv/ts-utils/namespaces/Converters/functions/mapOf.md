...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Converters](../README.md) / mapOf

# Function: mapOf()

**`Internal`**

Concrete implementation of Converters.(mapOf:1) \| Converters.mapOf(Converter\<T, TC\>),
Converters.(mapOf:2) \| Converters.mapOf(Converter\<T, TC\>, 'fail' or 'ignore'), and
Converters.mapOf(Converter\<T, TC\>, KeyedConverterOptions).

## Call Signature

> **mapOf**\<`T`, `TC`, `TK`\>(`converter`): [`Converter`](../../Conversion/interfaces/Converter.md)\<`Map`\<`TK`, `T`\>, `TC`\>
...
| ------ | ------ | ------ |
| `converter` | [`Converter`](../../Conversion/interfaces/Converter.md)\<`T`, `TC`\> \| [`Validator`](../../Validation/interfaces/Validator.md)\<`T`, `TC`\> | [Converter](../../Conversion/interfaces/Converter.md) | [Validator](../../Validation/interfaces/Validator.md) used for each item in the source object. |

### Returns

[`Converter`](../../Conversion/interfaces/Converter.md)\<`Map`\<`TK`, `T`\>, `TC`\>

A [Converter](../../Conversion/interfaces/Converter.md) which returns `Map<string, T>`.
...
> **mapOf**\<`T`, `TC`, `TK`\>(`converter`, `onError`): [`Converter`](../../Conversion/interfaces/Converter.md)\<`Map`\<`TK`, `T`\>, `TC`\>
...
> **mapOf**\<`T`, `TC`, `TK`\>(`converter`, `options`): [`Converter`](../../Conversion/interfaces/Converter.md)\<`Map`\<`TK`, `T`\>, `TC`\>

A helper function to create a [Converter](../../Conversion/interfaces/Converter.md) which converts the `string`-keyed properties
using a supplied [Converter\<T, TC\>](../../Conversion/interfaces/Converter.md) or [Validator\<T\>](../../Validation/interfaces/Validator.md) to produce
a `Map<TK,T>`.
...
A [Converter](../../Conversion/interfaces/Converter.md) which returns `Map<TK,T>`.
