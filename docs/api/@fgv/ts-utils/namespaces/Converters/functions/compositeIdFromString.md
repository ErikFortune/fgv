...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Converters](../README.md) / compositeIdFromString

# Function: compositeIdFromString()

> **compositeIdFromString**\<`TCOLLECTIONID`, `TITEMID`, `TC`\>(`collectionIdConverter`, `separator`, `itemIdConverter`): [`Converter`](../../Conversion/interfaces/Converter.md)\<[`ICompositeId`](../interfaces/ICompositeId.md)\<`TCOLLECTIONID`, `TITEMID`\>, `TC`\>

Converts a composite ID string into a strongly-typed [CompositeId](../interfaces/ICompositeId.md).
