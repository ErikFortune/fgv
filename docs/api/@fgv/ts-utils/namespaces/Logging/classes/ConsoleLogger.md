...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Logging](../README.md) / ConsoleLogger
...
> `protected` **\_log**(`message`, `level`): [`Success`](../../../classes/Success.md)\<`string` \| `undefined`\>
