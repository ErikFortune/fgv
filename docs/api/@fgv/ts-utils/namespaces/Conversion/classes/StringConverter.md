...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Conversion](../README.md) / StringConverter
...
Concrete implementation of Conversion.StringConverter.matching#string \| StringConverter.matching(string),
Conversion.StringConverter.matching#array \| StringConverter.matching(string\[\]),
Conversion.StringConverter.matching#set \| StringConverter.matching(Set\<string\>), and
Conversion.StringConverter.matching#regexp \| StringConverter.matching(RegExp).

#### Call Signature

> **matching**(`match`, `options?`): `StringConverter`\<`T`, `TC`\>

Returns a StringConverter which constrains the result to match
a supplied string.
...
| `options?` | `Partial`\<[`StringMatchOptions`](../interfaces/StringMatchOptions.md)\> | Optional [Conversion.StringMatchOptions](../interfaces/StringMatchOptions.md) for this conversion. |

##### Returns

`StringConverter`\<`T`, `TC`\>

[Success](../../../classes/Success.md) with a matching string or [Failure](../../../classes/Failure.md) with an informative
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `match` | `Set`\<`T`\> | The `Set` of allowed strings. |
| `options?` | `Partial`\<[`StringMatchOptions`](../interfaces/StringMatchOptions.md)\> | Optional [Conversion.StringMatchOptions](../interfaces/StringMatchOptions.md) for this conversion. |
...
> `protected` `static` **\_convert**\<`T`\>(`from`): [`Result`](../../../type-aliases/Result.md)\<`T`\>
...
> `protected` `static` **\_wrap**\<`T`, `TC`\>(`wrapped`, `converter`, `traits?`): `StringConverter`\<`T`, `TC`\>
...
| `converter` | (`from`) => [`Result`](../../../type-aliases/Result.md)\<`T`\> |
| `traits?` | [`ConverterTraits`](../interfaces/ConverterTraits.md) |
