...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Conversion](../README.md) / ObjectConverter

# Class: ObjectConverter\<T, TC\>

A [Converter](../interfaces/Converter.md) which converts an object of type `<T>` without changing shape, given
a [FieldConverters\<T\>](../type-aliases/FieldConverters.md) for the fields in the object.
...
be converted, the entire conversion fails. See [ObjectConverterOptions](../interfaces/ObjectConverterOptions.md)
...
> **new ObjectConverter**\<`T`, `TC`\>(`fields`, `options?`): `ObjectConverter`\<`T`, `TC`\>

Constructs a new ObjectConverter\<T, TC\> using options
supplied in a [ObjectConverterOptions\<T\>](../interfaces/ObjectConverterOptions.md).

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `fields` | [`FieldConverters`](../type-aliases/FieldConverters.md)\<`T`, `TC`\> | A [FieldConverters\<T\>](../type-aliases/FieldConverters.md) containing a [Converter](../interfaces/Converter.md) for each field |
| `options?` | [`ObjectConverterOptions`](../interfaces/ObjectConverterOptions.md)\<`T`\> | An optional |
...
ObjectConverterOptions to configure the conversion
...
> **new ObjectConverter**\<`T`, `TC`\>(`fields`, `optional?`): `ObjectConverter`\<`T`, `TC`\>

Constructs a new ObjectConverter\<T, TC\> with optional
...
| ------ | ------ | ------ |
| `fields` | [`FieldConverters`](../type-aliases/FieldConverters.md)\<`T`, `TC`\> | A [FieldConverters\<T\>](../type-aliases/FieldConverters.md) containing a [Converter](../interfaces/Converter.md) for each field. |
| `optional?` | keyof `T`[] | An array of `keyof T` listing fields that are not required. |
...
Use [.optional()](../interfaces/Converter.md#optional) on the individual
fields, or pass [ObjectConverterOptions\<T\>](../interfaces/ObjectConverterOptions.md) to the constructor.

#### Overrides

`BaseConverter<T, TC>.constructor`

## Properties

| Property | Modifier | Type | Default value | Description |
| ------ | ------ | ------ | ------ | ------ |
| <a id="_brand"></a> `_brand?` | `protected` | `string` | `undefined` | **`Internal`** |
| <a id="_defaultcontext"></a> `_defaultContext?` | `readonly` | `TC` | `undefined` | **`Internal`** |
| <a id="_isoptional"></a> `_isOptional` | `protected` | `boolean` | `false` | **`Internal`** |
| <a id="fields"></a> `fields` | `readonly` | [`FieldConverters`](../type-aliases/FieldConverters.md)\<`T`, `TC`\> | `undefined` | Fields converted by this ObjectConverter. |
| <a id="options"></a> `options` | `readonly` | [`ObjectConverterOptions`](../interfaces/ObjectConverterOptions.md)\<`T`\> | `undefined` | Options used to initialize this ObjectConverter. |
...
> `protected` **\_context**(`supplied?`): `TC` \| `undefined`
...
[`BaseConverter`](BaseConverter.md).[`_context`](BaseConverter.md#_context)

***

### \_traits()

> `protected` **\_traits**(`traits?`): [`ConverterTraits`](../interfaces/ConverterTraits.md)
...
| Parameter | Type |
| ------ | ------ |
| `traits?` | `Partial`\<[`ConverterTraits`](../interfaces/ConverterTraits.md)\> |
...
[`BaseConverter`](BaseConverter.md).[`_traits`](BaseConverter.md#_traits)
...
[`BaseConverter`](BaseConverter.md).[`_with`](BaseConverter.md#_with)

***

### addPartial()

> **addPartial**(`addOptionalProperties`): `ObjectConverter`\<`Partial`\<`T`\>, `TC`\>

Creates a new ObjectConverter derived from this one but with
...
A new ObjectConverter with the additional optional source
properties.
...
> **convertPartial**(`from`, `context?`): [`Result`](../../../type-aliases/Result.md)\<`Partial`\<`T`\>\>

Converts the supplied object using the ObjectConverter
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `from` | `unknown` | The object to be converted. |
| `context?` | `TC` | An optional context object passed to the field converters. |

#### Returns

[`Result`](../../../type-aliases/Result.md)\<`Partial`\<`T`\>\>

A [Result](../../../type-aliases/Result.md) containing the converted object or an error message.

***

### convertRequired()

> **convertRequired**(`from`, `context?`): [`Result`](../../../type-aliases/Result.md)\<`Required`\<`T`\>\>
...
Conversion.ObjectConverter.(partial:1) \| ObjectConverter.partial(ObjectConverterOptions) and
Conversion.ObjectConverter.(partial:2) \| ObjectConverter.partial((keyof T))\[\].
...
A new ObjectConverter with the additional optional source properties.

#### Call Signature

> **partial**(`options`): `ObjectConverter`\<`Partial`\<`T`\>, `TC`\>

Creates a new ObjectConverter derived from this one but with
new optional properties as specified by a supplied [ObjectConverterOptions\<T\>](../interfaces/ObjectConverterOptions.md).

##### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options` | [`ObjectConverterOptions`](../interfaces/ObjectConverterOptions.md)\<`T`\> | The [options](../interfaces/ObjectConverterOptions.md) to be applied to the new converter. |
...
> **partial**(`optional`): `ObjectConverter`\<`Partial`\<`T`\>, `TC`\>
...
`ObjectConverter`\<`Required`\<`T`\>, `TC`\>

A new ObjectConverter with the additional required source properties.
