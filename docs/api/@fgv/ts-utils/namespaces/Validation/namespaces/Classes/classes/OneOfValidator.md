...
[@fgv Monorepo API Documentation](../../../../../../../README.md) / [@fgv/ts-utils](../../../../../README.md) / [Validation](../../../README.md) / [Classes](../README.md) / OneOfValidator

# Class: OneOfValidator\<T, TC\>

An in-place [Validator](../../../interfaces/Validator.md) which validates that a supplied
...
> **new OneOfValidator**\<`T`, `TC`\>(`params`): `OneOfValidator`\<`T`, `TC`\>

Constructs a new OneOfValidator.

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`OneOfValidatorConstructorParams`](../interfaces/OneOfValidatorConstructorParams.md)\<`T`, `TC`\> | Optional [init params](../interfaces/OneOfValidatorConstructorParams.md) for the new OneOfValidator. |
...
| <a id="_validators"></a> `_validators` | `readonly` | [`Validator`](../../../interfaces/Validator.md)\<`T`, `TC`\>[] | - |
...
> `protected` **\_validate**\<`T`\>(`from`, `context?`, `self?`): `boolean` \| [`Failure`](../../../../../classes/Failure.md)\<`T`\>
