...
[@fgv Monorepo API Documentation](../../../../../../../README.md) / [@fgv/ts-utils](../../../../../README.md) / [Validation](../../../README.md) / [Classes](../README.md) / NumberValidator

# Class: NumberValidator\<T, TC\>

An in-place [Validator](../../../interfaces/Validator.md) for `number` values.
...
> **new NumberValidator**\<`T`, `TC`\>(`params?`): `NumberValidator`\<`T`, `TC`\>
...
| ------ | ------ | ------ |
| `params?` | [`NumberValidatorConstructorParams`](../type-aliases/NumberValidatorConstructorParams.md)\<`T`, `TC`\> | Optional [init params](../type-aliases/NumberValidatorConstructorParams.md) for the new NumberValidator. |

#### Returns

`NumberValidator`\<`T`, `TC`\>
...
[`GenericValidator`](../../Base/classes/GenericValidator.md).[`_context`](../../Base/classes/GenericValidator.md#_context)
...
> `static` **validateNumber**\<`T`\>(`from`): `boolean` \| [`Failure`](../../../../../classes/Failure.md)\<`T`\>
...
Returns `true` if `from` is a `number`, or [Failure](../../../../../classes/Failure.md) with an error
message if not.
