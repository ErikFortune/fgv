...
[@fgv Monorepo API Documentation](../../../../../../../README.md) / [@fgv/ts-utils](../../../../../README.md) / [Validation](../../../README.md) / [Classes](../README.md) / CompositeIdValidator

# Class: CompositeIdValidator\<T, TCOLLECTIONID, TITEMID, TC\>

An in-place [Validator](../../../interfaces/Validator.md) for a strongly-typed composite ID.
...
> **new CompositeIdValidator**\<`T`, `TCOLLECTIONID`, `TITEMID`, `TC`\>(`params`): `CompositeIdValidator`\<`T`, `TCOLLECTIONID`, `TITEMID`, `TC`\>

Constructs a new [StringValidator](StringValidator.md).

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`CompositeIdValidatorConstructorParams`](../interfaces/CompositeIdValidatorConstructorParams.md)\<`T`, `TCOLLECTIONID`, `TITEMID`, `TC`\> | Optional [init params](../type-aliases/StringValidatorConstructorParams.md) for the new [StringValidator](StringValidator.md). |
...
| ------ | ------ | ------ | ------ |
| <a id="_collectionidvalidator"></a> `_collectionIdValidator` | `readonly` | [`Validator`](../../../interfaces/Validator.md)\<`TCOLLECTIONID`, `TC`\> | - |
| <a id="_itemidvalidator"></a> `_itemIdValidator` | `readonly` | [`Validator`](../../../interfaces/Validator.md)\<`TITEMID`, `TC`\> | - |
| <a id="_options"></a> `_options` | `readonly` | [`ValidatorOptions`](../../../interfaces/ValidatorOptions.md)\<`TC`\> | **`Internal`** |
| <a id="_separator"></a> `_separator` | `readonly` | `string` | - |
...
> `protected` **\_validate**(`value`, `context?`): `boolean` \| [`Failure`](../../../../../classes/Failure.md)\<`T`\>
...
`true` if `from` is valid, [Failure\<T\>](../../../../../classes/Failure.md)
