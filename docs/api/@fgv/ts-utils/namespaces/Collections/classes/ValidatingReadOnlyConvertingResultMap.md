...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Collections](../README.md) / ValidatingReadOnlyConvertingResultMap

# Class: ValidatingReadOnlyConvertingResultMap\<TK, TSRC, TTARGET\>
...
> **new ValidatingReadOnlyConvertingResultMap**\<`TK`, `TSRC`, `TTARGET`\>(`params`): `ValidatingReadOnlyConvertingResultMap`\<`TK`, `TSRC`, `TTARGET`\>

Constructs a new ValidatingReadOnlyConvertingResultMap.

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`IValidatingReadOnlyConvertingResultMapConstructorParams`](../interfaces/IValidatingReadOnlyConvertingResultMapConstructorParams.md)\<`TK`, `TSRC`, `TTARGET`\> | Parameters for constructing the map. |

#### Returns

`ValidatingReadOnlyConvertingResultMap`\<`TK`, `TSRC`, `TTARGET`\>
...
[`ReadOnlyConvertingResultMap`](ReadOnlyConvertingResultMap.md).[`_clearCache`](ReadOnlyConvertingResultMap.md#_clearcache)
...
[`ReadOnlyConvertingResultMap`](ReadOnlyConvertingResultMap.md).[`_clearCacheEntry`](ReadOnlyConvertingResultMap.md#_clearcacheentry)
...
> `static` **create**\<`TK`, `TSRC`, `TTARGET`\>(`params`): [`Result`](../../../type-aliases/Result.md)\<`ValidatingReadOnlyConvertingResultMap`\<`TK`, `TSRC`, `TTARGET`\>\>

Creates a new ValidatingReadOnlyConvertingResultMap.
...
[`Result`](../../../type-aliases/Result.md)\<`ValidatingReadOnlyConvertingResultMap`\<`TK`, `TSRC`, `TTARGET`\>\>
