...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Collections](../README.md) / CollectorValidator
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `item` | `unknown` | The weakly-typed item to get or add. |
