...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-utils](../../../README.md) / [Collections](../README.md) / ValidatingCollector

# Class: ValidatingCollector\<TITEM\>

A [Collector](Collector.md) with a [CollectorValidator](CollectorValidator.md)
...
> **new ValidatingCollector**\<`TITEM`\>(`params`): `ValidatingCollector`\<`TITEM`\>

Constructs a new ValidatingConvertingCollector
from the supplied [parameters](../interfaces/IValidatingCollectorConstructorParams.md).

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `params` | [`IValidatingCollectorConstructorParams`](../interfaces/IValidatingCollectorConstructorParams.md)\<`TITEM`\> | Required parameters for constructing the collector. |

#### Returns

`ValidatingCollector`\<`TITEM`\>
...
| ------ | ------ | ------ | ------ |
| <a id="_converters"></a> `_converters` | `readonly` | [`KeyValueConverters`](KeyValueConverters.md)\<[`CollectibleKey`](../type-aliases/CollectibleKey.md)\<`TITEM`\>, `TITEM`\> | - |
| <a id="validating"></a> `validating` | `readonly` | [`CollectorValidator`](CollectorValidator.md)\<`TITEM`\> | A [CollectorValidator](CollectorValidator.md) which validates keys and values before inserting them into this collector. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`CollectibleKey`](../type-aliases/CollectibleKey.md)\<`TITEM`\> | The key to look up. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `key` | [`CollectibleKey`](../type-aliases/CollectibleKey.md)\<`TITEM`\> | The key to check for. |
...
> `static` **createValidatingCollector**\<`TITEM`\>(`params`): [`Result`](../../../type-aliases/Result.md)\<`ValidatingCollector`\<`TITEM`\>\>

Creates a new ValidatingCollector instance from
the supplied [parameters](../interfaces/IValidatingCollectorConstructorParams.md).
...
[`Result`](../../../type-aliases/Result.md)\<`ValidatingCollector`\<`TITEM`\>\>
