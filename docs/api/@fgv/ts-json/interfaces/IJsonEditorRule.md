...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json](../README.md) / IJsonEditorRule
...
| `value` | [`JsonValue`](../../ts-res-ui-components/type-aliases/JsonValue.md) | The `JsonValue` of the property to be edited. |
