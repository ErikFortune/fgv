...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json](../../../README.md) / [Diff](../README.md) / jsonEquals
...
| ------ | ------ | ------ |
| `obj1` | [`JsonValue`](../../../../ts-res-ui-components/type-aliases/JsonValue.md) | The first JSON value to compare |
| `obj2` | [`JsonValue`](../../../../ts-res-ui-components/type-aliases/JsonValue.md) | The second JSON value to compare |
