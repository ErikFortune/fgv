...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json](../../../README.md) / [Diff](../README.md) / jsonThreeWayDiff

# Function: jsonThreeWayDiff()

> **jsonThreeWayDiff**(`obj1`, `obj2`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IThreeWayDiff`](../interfaces/IThreeWayDiff.md)\>
...
| ------ | ------ | ------ |
| `obj1` | [`JsonValue`](../../../../ts-res-ui-components/type-aliases/JsonValue.md) | The first JSON value to compare (often the "before" or "source" state) |
| `obj2` | [`JsonValue`](../../../../ts-res-ui-components/type-aliases/JsonValue.md) | The second JSON value to compare (often the "after" or "target" state) |

## Returns

[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IThreeWayDiff`](../interfaces/IThreeWayDiff.md)\>
