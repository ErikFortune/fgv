...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json](../README.md) / JsonEditorConverter
...
- [`BaseConverter`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`JsonValue`](../../ts-res-ui-components/type-aliases/JsonValue.md), [`IJsonContext`](../interfaces/IJsonContext.md)\>
...
`Conversion.BaseConverter._context`
...
`Conversion.BaseConverter._traits`
...
`Conversion.BaseConverter._with`
...
> `static` **createWithEditor**(`editor`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonEditorConverter`\>
...
[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonEditorConverter`\>
