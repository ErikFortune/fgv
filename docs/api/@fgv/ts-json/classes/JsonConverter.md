...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json](../README.md) / JsonConverter
...
> `static` **create**(`options?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonConverter`\>
...
[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonConverter`\>
