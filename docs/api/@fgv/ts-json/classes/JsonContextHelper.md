...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json](../README.md) / JsonContextHelper
...
| ------ | ------ | ------ | ------ |
| <a id="_context"></a> `_context?` | `protected` | [`IJsonContext`](../interfaces/IJsonContext.md) | **`Internal`** The base [context](../interfaces/IJsonContext.md) on which we are operating. |

## Methods

### extendContext()

> **extendContext**(`add?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonContext`](../interfaces/IJsonContext.md) \| `undefined`\>
...
> **extendRefs**(`refs?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonReferenceMap`](../interfaces/IJsonReferenceMap.md) \| `undefined`\>
...
[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonReferenceMap`](../interfaces/IJsonReferenceMap.md) \| `undefined`\>
...
> **extendVars**(`vars?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`TemplateVars`](../type-aliases/TemplateVars.md) \| `undefined`\>
...
> **mergeContext**(`merge?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonContext`](../interfaces/IJsonContext.md) \| `undefined`\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `merge?` | [`IJsonContext`](../interfaces/IJsonContext.md) | Optional initializer containing [variable values](../type-aliases/VariableValue.md) and/or [reference maps](../interfaces/IJsonReferenceMap.md) to be added to the [context](../interfaces/IJsonContext.md). |
...
> `static` **create**(`context?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonContextHelper`\>
...
[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`JsonContextHelper`\>
...
> `static` **extendContext**(`baseContext?`, `add?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonContext`](../interfaces/IJsonContext.md) \| `undefined`\>
...
> `static` **extendContextRefs**(`baseContext`, `refs?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonReferenceMap`](../interfaces/IJsonReferenceMap.md) \| `undefined`\>
...
> `static` **extendContextVars**(`baseContext`, `vars?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`TemplateVars`](../type-aliases/TemplateVars.md) \| `undefined`\>
...
> `static` **mergeContext**(`baseContext`, `add`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`IJsonContext`](../interfaces/IJsonContext.md) \| `undefined`\>
