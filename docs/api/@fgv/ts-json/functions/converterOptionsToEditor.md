...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json](../README.md) / converterOptionsToEditor

# Function: converterOptionsToEditor()

> **converterOptionsToEditor**(`partial?`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`JsonEditor`](../classes/JsonEditor.md)\>
...
[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`JsonEditor`](../classes/JsonEditor.md)\>
