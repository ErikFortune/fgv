...
[@fgv Monorepo API Documentation](../../../../../../../README.md) / [@fgv/ts-json-base](../../../../../README.md) / [JsonCompatible](../../../README.md) / [Converters](../README.md) / object

# Function: object()

> **object**\<`T`, `TC`\>(`properties`, `options?`): [`ObjectConverter`](../../../type-aliases/ObjectConverter.md)\<`T`, `TC`\>
...
| `options?` | [`ObjectConverterOptions`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<[`JsonCompatibleType`](../../../../../type-aliases/JsonCompatibleType.md)\<`T`\>\> | The options to use for the conversion. |
