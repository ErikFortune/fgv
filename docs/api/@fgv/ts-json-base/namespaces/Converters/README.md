...
[@fgv Monorepo API Documentation](../../../../README.md) / [@fgv/ts-json-base](../../README.md) / Converters

# Converters

## Interfaces

- [IJsonConverterContext](interfaces/IJsonConverterContext.md)
...
- [jsonConverter](functions/jsonConverter.md)
