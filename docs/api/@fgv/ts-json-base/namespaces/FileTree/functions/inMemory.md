...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json-base](../../../README.md) / [FileTree](../README.md) / inMemory

# Function: inMemory()

## Call Signature

> **inMemory**\<`TCT`\>(`files`, `prefix?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`FileTree`](../classes/FileTree.md)\<`TCT`\>\>
...
> **inMemory**\<`TCT`\>(`files`, `params?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`FileTree`](../classes/FileTree.md)\<`TCT`\>\>
