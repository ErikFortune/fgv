...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json-base](../../../README.md) / [JsonFile](../README.md) / convertJsonFileSync

# Function: convertJsonFileSync()

> **convertJsonFileSync**\<`T`, `TC`\>(`srcPath`, `converter`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`T`\>
