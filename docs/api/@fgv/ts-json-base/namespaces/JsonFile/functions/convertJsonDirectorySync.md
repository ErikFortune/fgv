...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json-base](../../../README.md) / [JsonFile](../README.md) / convertJsonDirectorySync

# Function: convertJsonDirectorySync()

> **convertJsonDirectorySync**\<`T`, `TC`\>(`srcPath`, `options`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IReadDirectoryItem`](../interfaces/IReadDirectoryItem.md)\<`T`\>[]\>
