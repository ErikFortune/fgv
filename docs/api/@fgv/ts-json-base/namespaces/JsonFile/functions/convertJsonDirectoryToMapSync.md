...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json-base](../../../README.md) / [JsonFile](../README.md) / convertJsonDirectoryToMapSync

# Function: convertJsonDirectoryToMapSync()

> **convertJsonDirectoryToMapSync**\<`T`, `TC`\>(`srcPath`, `options`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`Map`\<`string`, `T`\>\>
