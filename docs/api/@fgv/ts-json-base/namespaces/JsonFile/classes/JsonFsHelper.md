...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-json-base](../../../README.md) / [JsonFile](../README.md) / JsonFsHelper
...
> **convertJsonDirectorySync**\<`T`, `TC`\>(`srcPath`, `options`, `context?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IReadDirectoryItem`](../interfaces/IReadDirectoryItem.md)\<`T`\>[]\>
...
> **convertJsonDirectoryToMapSync**\<`T`, `TC`\>(`srcPath`, `options`, `context?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`Map`\<`string`, `T`\>\>
...
> **convertJsonFileSync**\<`T`, `TC`\>(`srcPath`, `cv`, `context?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`T`\>
...
> **writeJsonFileSync**(`srcPath`, `value`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`boolean`\>
