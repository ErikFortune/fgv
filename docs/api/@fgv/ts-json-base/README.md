...
[@fgv Monorepo API Documentation](../../README.md) / @fgv/ts-json-base
...
- [FileTree](namespaces/FileTree/README.md)
- [JsonCompatible](namespaces/JsonCompatible/README.md)
- [JsonFile](namespaces/JsonFile/README.md)
