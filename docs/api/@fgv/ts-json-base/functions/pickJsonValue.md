...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-json-base](../README.md) / pickJsonValue

# Function: pickJsonValue()

> **pickJsonValue**(`src`, `path`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<[`JsonValue`](../type-aliases/JsonValue.md)\>
