...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-sudoku-lib](../README.md) / PuzzleSession
...
> `protected` **new PuzzleSession**(`puzzle`): `PuzzleSession`
...
> **redo**(): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>

Redo a single move in this puzzle session.

#### Returns

[`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
...
> **undo**(): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
...
> **updateCellNotes**(`spec`, `notes`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
...
> **updateCells**(`updates`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
...
> **updateCellValue**(`spec`, `value`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
...
> `static` **create**(`puzzle`): [`Result`](../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSession`\>
