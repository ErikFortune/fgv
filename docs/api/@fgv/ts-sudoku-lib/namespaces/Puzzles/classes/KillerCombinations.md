...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Puzzles](../README.md) / KillerCombinations
...
> `static` **getCellPossibilities**(`puzzle`, `state`, `cage`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`Map`\<[`CellId`](../../../type-aliases/CellId.md), `number`[]\>\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`Map`\<[`CellId`](../../../type-aliases/CellId.md), `number`[]\>\>
...
> `static` **getCombinations**(`cageSize`, `total`, `constraints?`, `maxValue?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`number`[][]\>
...
> `static` **getPossibleTotals**(`cageSize`, `maxValue`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`number`[]\>
