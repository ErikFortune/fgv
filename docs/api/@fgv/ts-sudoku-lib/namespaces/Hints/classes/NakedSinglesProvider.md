...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / NakedSinglesProvider
...
> `static` **create**(): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`NakedSinglesProvider`\>

Static factory method to create a new NakedSinglesProvider.

#### Returns

[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`NakedSinglesProvider`\>
