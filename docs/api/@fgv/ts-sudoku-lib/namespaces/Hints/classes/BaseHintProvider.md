...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / BaseHintProvider
...
> `abstract` **generateHints**(`puzzle`, `state`, `options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHint`](../interfaces/IHint.md)[]\>
