...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / HintRegistry
...
> **clear**(): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`void`\>
...
> **generateAllHints**(`puzzle`, `state`, `options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHint`](../interfaces/IHint.md)[]\>
...
> **getProvider**(`techniqueId`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IHintProvider`](../interfaces/IHintProvider.md)\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IHintProvider`](../interfaces/IHintProvider.md)\>
...
> `static` **create**(`providers?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`HintRegistry`\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`HintRegistry`\>
