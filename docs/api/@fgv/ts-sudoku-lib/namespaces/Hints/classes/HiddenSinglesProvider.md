...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / HiddenSinglesProvider
...
> **new HiddenSinglesProvider**(): `HiddenSinglesProvider`
...
Result containing array of hidden single hints
...
> `protected` **validateOptions**(`options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`void`\>
...
> `static` **create**(): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`HiddenSinglesProvider`\>

Static factory method to create a new HiddenSinglesProvider.

#### Returns

[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`HiddenSinglesProvider`\>
