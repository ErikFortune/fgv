...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / PuzzleSessionHints
...
> **applyHint**(`hint`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **getAllHints**(`options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHint`](../interfaces/IHint.md)[]\>
...
> **getCellContents**(`spec`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<\{ `cell`: [`ICell`](../../../interfaces/ICell.md); `contents`: [`ICellContents`](../../../interfaces/ICellContents.md); \}\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<\{ `cell`: [`ICell`](../../../interfaces/ICell.md); `contents`: [`ICellContents`](../../../interfaces/ICellContents.md); \}\>
...
> **getHint**(`options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IHint`](../interfaces/IHint.md)\>
...
> **getHintsForCell**(`spec`, `options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHint`](../interfaces/IHint.md)[]\>
...
> **getHintStatistics**(`options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<\{ `hintsByDifficulty`: `Map`\<`string`, `number`\>; `hintsByTechnique`: `Map`\<`string`, `number`\>; `totalHints`: `number`; \}\>
...
> **hasHints**(`options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`boolean`\>
...
> **redo**(): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **undo**(): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **updateCellNotes**(`spec`, `notes`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **updateCells**(`updates`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **updateCellValue**(`spec`, `value`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
...
> **validateHint**(`hint`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`void`\>
...
> `static` **create**(`session`, `config?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`PuzzleSessionHints`\>
