...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-sudoku-lib](../../../README.md) / [Hints](../README.md) / ExplanationRegistry
...
> **getExplanationAtLevel**(`hint`, `level`, `puzzle`, `state`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IHintExplanation`](../interfaces/IHintExplanation.md)\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`IHintExplanation`](../interfaces/IHintExplanation.md)\>
...
> **getExplanations**(`hint`, `puzzle`, `state`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHintExplanation`](../interfaces/IHintExplanation.md)[]\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<readonly [`IHintExplanation`](../interfaces/IHintExplanation.md)[]\>
