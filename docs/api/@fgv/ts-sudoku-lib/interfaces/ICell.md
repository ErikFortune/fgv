...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-sudoku-lib](../README.md) / ICell
...
| ------ | ------ | ------ | ------ |
| <a id="cages"></a> `cages` | `readonly` | readonly [`ICage`](ICage.md)[] | All of the [cages](ICage.md) to which this cell belongs. |
