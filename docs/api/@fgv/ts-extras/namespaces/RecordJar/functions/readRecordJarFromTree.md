...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-extras](../../../README.md) / [RecordJar](../README.md) / readRecordJarFromTree

# Function: readRecordJarFromTree()

> **readRecordJarFromTree**(`fileTree`, `filePath`, `options?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<[`JarRecord`](../type-aliases/JarRecord.md)[]\>
