...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-extras](../../../README.md) / [CryptoUtils](../README.md) / DirectEncryptionProvider
...
> `static` **create**(`params`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`DirectEncryptionProvider`\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`DirectEncryptionProvider`\>
