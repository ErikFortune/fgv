...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-extras](../../../README.md) / [CryptoUtils](../README.md) / ICreateEncryptedFileParams
...
| ------ | ------ | ------ | ------ |
| <a id="content"></a> `content` | `readonly` | [`JsonValue`](../../../../ts-res-ui-components/type-aliases/JsonValue.md) | The JSON content to encrypt. |
