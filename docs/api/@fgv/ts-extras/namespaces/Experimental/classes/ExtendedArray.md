...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-extras](../../../README.md) / [Experimental](../README.md) / ExtendedArray
...
> **atLeastOne**(`failMessage?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`T`[]\>
...
> **first**(`failMessage?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`T`\>
...
> **single**(`predicate?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`T`\>
