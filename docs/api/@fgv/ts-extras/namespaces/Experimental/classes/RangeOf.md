...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-extras](../../../README.md) / [Experimental](../README.md) / RangeOf
...
> `protected` **\_compare**(`t1`, `t2`): `"equal"` \| `"less"` \| `"greater"`
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `t1` | `T` | First value to compare. |
| `t2` | `T` | Second value to compare. |

#### Returns

`"equal"` \| `"less"` \| `"greater"`

`'less'` if `t1` is less than `t2`, `'greater'` if `t1` is larger
...
> `protected` `static` **\_defaultCompare**\<`T`\>(`t1`, `t2`): `"equal"` \| `"less"` \| `"greater"`
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `t1` | `T` | First value to be compared. |
| `t2` | `T` | Second value to be compared. |
...
> `static` **createRange**\<`T`\>(`init?`): [`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`RangeOf`\<`T`\>\>
...
[`Result`](../../../../ts-res-ui-components/type-aliases/Result.md)\<`RangeOf`\<`T`\>\>
