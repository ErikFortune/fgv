...
[@fgv Monorepo API Documentation](../../../../README.md) / [@fgv/ts-extras](../../README.md) / AiAssist
...
- [DEFAULT\_AI\_ASSIST](variables/DEFAULT_AI_ASSIST.md)
- [MODEL\_SPEC\_BASE\_KEY](variables/MODEL_SPEC_BASE_KEY.md)
