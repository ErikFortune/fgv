...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-res-ui-components](../README.md) / ResourceTreeView

# Variable: ResourceTreeView

> `const` **ResourceTreeView**: `React.FC`\<`IResourceTreeViewProps`\>
