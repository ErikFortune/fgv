...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-res-ui-components](../README.md) / SourceResourceDetail

# Variable: SourceResourceDetail

> `const` **SourceResourceDetail**: `React.FC`\<`ISourceResourceDetailProps`\>
