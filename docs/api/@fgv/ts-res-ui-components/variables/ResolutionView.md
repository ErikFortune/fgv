...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-res-ui-components](../README.md) / ResolutionView

# Variable: ResolutionView

> `const` **ResolutionView**: `React.FC`\<[`IResolutionViewProps`](../namespaces/ResolutionTools/interfaces/IResolutionViewProps.md)\>
