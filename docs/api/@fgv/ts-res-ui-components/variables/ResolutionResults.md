...
[@fgv Monorepo API Documentation](../../../README.md) / [@fgv/ts-res-ui-components](../README.md) / ResolutionResults

# Variable: ResolutionResults

> `const` **ResolutionResults**: `React.FC`\<`IResolutionResultsProps`\>
