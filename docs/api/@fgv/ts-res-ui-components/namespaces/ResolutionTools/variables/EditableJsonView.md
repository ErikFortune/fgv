...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-res-ui-components](../../../README.md) / [ResolutionTools](../README.md) / EditableJsonView

# Variable: EditableJsonView

> `const` **EditableJsonView**: `React.FC`\<[`IEditableJsonViewProps`](../interfaces/IEditableJsonViewProps.md)\>
