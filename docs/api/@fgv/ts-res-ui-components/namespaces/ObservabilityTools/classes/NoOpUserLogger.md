...
[@fgv Monorepo API Documentation](../../../../../README.md) / [@fgv/ts-res-ui-components](../../../README.md) / [ObservabilityTools](../README.md) / NoOpUserLogger
...
> **new NoOpUserLogger**(`logLevel?`): `NoOpUserLogger`
...
> `protected` **\_log**(`message`, `__level`): [`Success`](https://github.com/ErikFortune/fgv/tree/main/libraries/ts-utils/docs)\<`string` \| `undefined`\>
