...
**Substrate:** `.ai/tasks/active/ts-agent-memory/` (on integration branch `ts-agent-memory`) — `brief.md`, `exploration.md`, `design.md`, `design-lock.md` (Phase-A output), `consumer-requirements-personaility.md`, `consumer-assessment-personaility.md`, `state.md`.
