...
**Shipped to `release`** (2026-07-07), PRs #518.

CI runs `rush test`, so the coverage gate is enforced (#518).
...
`brief.md` and `findings.md`, archived read-only alongside this file, plus the reconstructed `meta.yaml`.
