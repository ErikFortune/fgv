...
- [x] A matched pair of probe passes differing in `_clear` alone, so arm64 can isolate its
      contribution — read asymmetrically: an abort implicates, a survival exonerates nothing
