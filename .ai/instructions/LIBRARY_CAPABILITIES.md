...
- **2026-09-07** — ai-assist now places explicit prompt-cache breakpoints on Anthropic and OpenAI requests built from a ts-prompt-assist resolve… ([#668](https://github.com/ErikFortune/fgv/pull/668)) · `ts-extras` `ts-prompt-assist`
