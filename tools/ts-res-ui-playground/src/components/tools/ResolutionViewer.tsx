    ...
    <div className="p-6">
      ...
      <div className="mb-6 bg-red-50 border-2 border-red-200 rounded-lg p-4">
        <div className="flex items-center">
          <MagnifyingGlassIcon className="h-6 w-6 text-red-600 mr-3 flex-shrink-0" />
          <div>
            <h3 className="text-lg font-semibold text-red-800 mb-1">⚠️ DEPRECATED COMPONENT</h3>
            <p className="text-red-700 text-sm">
              This local ResolutionViewer component is <strong>obsolete and not used</strong>. The application
              uses the shared
              <code className="bg-red-100 px-1 rounded mx-1">ResolutionView</code> component from
